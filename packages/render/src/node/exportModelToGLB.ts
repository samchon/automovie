 ...
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-articulation Generic model serialization writes posed mesh buffers; landmark resolution, joint articulation and attachment posing happen in the human builder before this boundary.
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-connected-iris GLB export writes whatever texture the material holds; the iris texels are painted by the human builder before export.
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-connected-fibre GLB export writes whatever texture the material holds; fibre colour and coverage are painted by the human builder before export.
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-contact Generic model serialization writes resolved mesh buffers; oral contact evaluation happens in the human builder before this boundary.
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-parametric-hair Generic model serialization writes completed mesh buffers and materials; numerical scalp sampling and hair integration happen before this boundary.
