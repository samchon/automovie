 ...
 * it carries (named weights, pose angles, material scalars) and the
 ...
 * identity rows instead of dropping them. A pose that names one bone twice is
 * refused here, because no basis makes that meaningful.
 *
