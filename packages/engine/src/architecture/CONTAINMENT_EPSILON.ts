/**
 * Shared by builtSpaceContainsPoint, builtSpaceShellVolume, which were one file until each public identity took its own.
 *
 ...
 * @author Samchon
 */
export const CONTAINMENT_EPSILON = 1e-9;
