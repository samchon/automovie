/**
 * Shared by validateBuiltEnvironment, builtSpaceShellVolume, builtEnvironmentDescendantSpaces, which were one file until each public identity took its own.
 *
 ...
 * @author Samchon
 */
export const PLANE_NORMAL_EPSILON = 1e-12;
