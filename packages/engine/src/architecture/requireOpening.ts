/**
 * Shared by builtOpeningPanelPlacements, builtOpeningSweepEnvelope, builtConnectorSection, which were one file until each public identity took its own.
 *
