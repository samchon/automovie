 ...
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-parametric-hair The editor submits numerical documents to its model adapter; the human builder owns scalp sampling, styling fields and strip integration.
 ...
 * @evidenceExclude requirements/actors/facial-authoring/contract.md#actor-face-articulation The panel delegates model construction to its preview adapter; facial joints, landmarks and attachment weights are evaluated by the human package.
 * @evidenceExclude requirements/actors/facial-authoring/contract.md#actor-face-contact The panel delegates model evaluation; the connected runtime reports the contact summary the human builder measured.
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-articulation The panel owns inputs and history only; the rest layer, landmark articulation and attachment posing order belong to the human builder.
 * @evidenceExclude specifications/asset-and-representation/facial-authoring/contract.md#face-spec-contact The panel prints apertures and resolution counts; the evaluation order lives in the human builder.
