 ...
 * @evidenceReview spaces/001-citizen-house.md #c9f6f2d 현재 citizenHouseSpaceSource는 buildHouse의 topology·storey·envelope·garden·rooms 결과를 등록한다. 방 fit-out은 settings/003#surface-decomposition의 이관 중 소비 경로다. 현재 건축 부재가 컴파일되는 사실과 새 트리의 전체 공간·GPU 승인도 구분한다.
 ...
 * @evidenceReview spaces/001-citizen-house.md#site-access #d9b6e18 garden.ts가 site-ground에서 본채 외곽을 빼고, approach tread 두 개(상단 -0.30·-0.15)와 landing(0)을 지면 -0.45부터 채우며 entryApproach x=1.30..2.90을 쓰는 것을 읽었다. compiled scene에서 두 tread와 landing, rear-paving이 모두 y=-0.45에서 시작하고, service-band 네 조각·cassette-staging-pad·site-sidewalk 두 조각이 흙 site-ground와 같은 y=-0.852..-0.45를 채우고, catch-bottom 하면 -0.852와 출구 원(y=-0.85..-0.75)이 흙 깊이 안에 있다. 본문에 없던 site-curb는 더 이상 생성되지 않아 보도·예약면과 겹치는 site 부재가 없다.
