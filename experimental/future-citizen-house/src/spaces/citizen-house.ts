 ...
 * @evidenceReview spaces/001-citizen-house.md #04f20e1 현재 citizenHouseSpaceSource는 buildHouse의 topology·storey·envelope·garden·rooms 결과를 등록한다. 방 fit-out과 조경의 직접 material 문자열은 이관 중 소비 경로이며 최종 finish 결합은 materials가 결정한다. 현재 건축 부재가 컴파일되는 사실과 새 트리의 전체 공간·GPU 승인도 구분한다.
