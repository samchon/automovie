 ...
 * @evidenceReview spaces/003-surface-ownership.md#roof-face #a1ef28b v-075가 roof/right의 경사·배수와 native cassette70·girder3·rail44·post9를 대조해 충실도를 통과시켰다. 동일 구현의 WebGL2 외관·상부·하부 캡처를 열어 셀 간격과 프레임·레일 리듬을 확인했고 검은 연속면의 시각 결함은 PASS로 닫혔다. 이 export는 지붕과 관 연결을 만들며 후면 식재의 실행은 site-access의 garden 소유 관계에 남긴다. 이번 조경 설계 추적 보완의 r3 판정을 대신하지 않는다.
