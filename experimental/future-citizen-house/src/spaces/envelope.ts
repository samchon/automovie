 ...
 * @evidenceReview spaces/003-surface-ownership.md #e5cf9dc envelope()가 front·rear·left·right·roof 다섯 owner를 호출하고, 각 입면의 facade()와 corners()가 자기 벽·창호·차양·모서리 geometry를 만든다. right.ts의 배수관·clip·덮개도 현재 구현되어 있다. v-096의 외피 설계 PASS는 이 건축 범위의 역사이며 현 트리의 재료 결합이나 새 GPU 외관을 승인하지 않는다.
 ...
 * @evidence spaces/003-surface-ownership.md#glazing-interface 각 창의 jamb·mullion은 member 중심에서 body·web·압착판·덮개 네 부재, head·sill은 bay마다 같은 단면의 네 부재를 인접 수직 부재의 같은 부재 face까지 이어 맞댄다. 유리는 seat 안으로 0.006 들어가고 gasket과 setting block이 받친다. cut 안쪽 reveal, 층간 cassette, 입면 몸체 끝에서 자른 drip, 전면·좌측 작업실과 침실 창의 하부 루버를 같은 owner가 만들고, 후면 주침실 창에는 루버를 두지 않는다.
 * @evidenceReview spaces/003-surface-ownership.md#glazing-interface #e3355ca curtainwall.ts의 SECTION 표(body s±0.020 n-0.070..-0.015, web ±0.010, 압착판 ±0.020 0.015..0.035, 모따기 없는 직사각 덮개 ±0.018 0.035..0.070), 유리 L-0.006..R+0.006, gasket abs(s) 0.014..0.020, head·sill 네 부재를 인접 수직 부재의 같은 부재 face(본체·압착판 m±0.020, web m±0.010, 덮개 m±0.018)까지 잇는 horizontal(), reveal 0.004/0.006, cassette 2.844..3.246·n 0.138..0.140과 anchor n 0.100..0.138을 본문 수치와 대조했다. 루버는 k=15·p=0.078·40% 날개, 속이 찬 지지대, 끝판을 지나 지지대 안 0.008에서 끝나는 체결구 몸체, n=-0.050에서 끝나는 arm bolt, LOUVRED 다섯 창과 현관 접근 bay 제외를 읽었다. compiled scene에서 cassette 17장, 날개 180장(front-flex 30·front-bedroom 30·left-flex 45·left-bedroom 45·left-child-two 30), 지지대 17·arm 34를 셌고 rear-bedroom 루버는 0이다. 후면 drip은 x=-5.26..5.26, front-flex drip은 x=3.00..5.26에서 끝나 모서리 prism과의 AABB 겹침이 0이고, 나무 부재와 루버의 AABB 겹침도 0이다. front-flex head-0 덮개 x=3.058..4.122·web 3.05..4.13이 mullion-1 덮개 4.122·web 4.13에 맞닿고, 창틀 부재끼리 및 창틀과 유리·gasket·setting block의 부피 겹침이 0이며, 낮·사적·야간 세 산출물의 루버 part 1379개 bounds가 같다.
