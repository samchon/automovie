...
export function primary(a: Assembly): void {
  ...
  for (const x of [1.60, 4.16]) { cabinet(new Item(a, "primary-nightstand-" + x, r, x, 3.2, 3.47), 0.5, 0.46, 0.46); a.ellipsoid("primary-lamp-" + x, r, "glow", x, 3.89, 3.47, 0.22, 0.27, 0.22); }
