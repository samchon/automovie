...
export function serviceUpper(a: Assembly): void {
  ...
  for (let i = 0; i < 2; i++) { laundry.box("machine-" + i, "white", 0, 0.43 + i * 0.86, 0, 0.66, 0.84, 0.66); laundry.round("drum-" + i, "metal", 0, 0.43 + i * 0.86, 0.34, 0.46, 0.46, 0.03); laundry.round("window-" + i, "glass", 0, 0.43 + i * 0.86, 0.36, 0.35, 0.35, 0.022); laundry.box("controls-" + i, "metal", 0.1, 0.75 + i * 0.86, 0.342, 0.25, 0.055, 0.014); }
