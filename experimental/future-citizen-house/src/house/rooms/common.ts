...
export function common(a: Assembly): void {
  ...
  sofa.box("plinth", "oak", 0, 0.14, 0, 2.7, 0.15, 0.91);
  sofa.box("back", "linen", 0, 0.68, -0.39, 2.7, 0.68, 0.19);
  ...
  for (const s of [-1, 1]) sofa.box("arm-" + s, "linen", s * 1.28, 0.54, 0, 0.18, 0.52, 0.95);
  a.box("common-rug", r, "linen", 3.61, 0.008, 2.78, 2.8, 0.016, 3.65);
  table(new Item(a, "common-coffee", r, 4.05, 0, 2.85), 0.9, 1.25, 0.36);
  ...
  cabinet(island, 0.88, 0.87, 2.65, false, "green"); island.box("counter", "white", 0, 0.91, 0, 1.02, 0.06, 2.82);
  island.box("sink", "steel", 0, 0.944, 0.65, 0.58, 0.008, 0.46); island.box("sink-basin", "metal", 0, 0.95, 0.65, 0.48, 0.01, 0.36);
  ...
  cabinet(bank, 2.9, 0.87, 0.62, false, "green"); bank.box("worktop", "white", 0, 0.91, 0, 3, 0.055, 0.67); bank.box("hob", "metal", 0, 0.942, 0, 0.65, 0.012, 0.50);
  for (const x of [-0.17, 0.17]) for (const z of [-0.12, 0.12]) bank.round("hob-ring-" + x + "-" + z, "steel", x, 0.951, z, 0.13, 0.006, 0.13);
