...
@evidence principles/design/materials.md#material-verification-address 경계 y, frame 바깥선에서 끝나는 띠 끝, 그 끝을 가로지르는 front-face-stone-panels:1-4-0·rear-face-stone-panels:2-3-0의 panel 안 도장 경계, 외향/반환면 배정, slab 외곽이 외장 평면에 나오지 않는지와 도장이 새 부재처럼 떠 보이는지를 scale-and-junction-samples의 층간 표본에서, 띠의 색·반사를 ref01 대조에서 반증한다.
