...
@evidence spaces/003-surface-ownership.md#rear-bedroom-glazing 주침실 후면창 일곱 bay의 하부 band가 frosted를 받는다.
...
@evidence principles/core/common.md#declared-basis 부재 수와 PV 표현은 v-076이 닫은 roof-face와 canopy-finish.ts에서 받고, 이를 재료 변경의 보존 경계로 삼는 것은 이 층의 선택이다.
...
@evidence principles/design/materials.md#material-verification-address 외관·top·soffit의 셀 간격·frame·rail 리듬을 reference-material-samples의 지붕 회귀 표본에서 같은 카메라로 대조한다.
