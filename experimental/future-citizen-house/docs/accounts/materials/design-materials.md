...
<!--
@evidence obligations/design/materials.md#addressable-material-decisions 새 마감 26종과 보존·retained 역할, texture family 9종, 관찰 4역할을 29 H2에 배정한다. 석재 입자, 층간 띠 경계, 목재 끝면, 도기와 좌판의 광택처럼 따로 바뀌는 결정은 각자 H2를 갖고, 같은 구성·좌표·표본을 공유하는 변형(직물 네 색, steel과 거울, 두 가구 목재, 두 joinery 도장)만 한 H2 안의 명시 항목으로 둔다.
...
@evidence obligations/design/materials.md#material-surface-assignment 001의 역할 주소 위에서 002~006이 표면군을 나눠 받고 wood-end·floor-band·retained로 끝면·부분 띠·보존 면까지 배정한다. 공유 벽의 양면처럼 두 마감이 만나는 곳은 실제 벽·문턱·junction에서만 바뀐다.
...
| floor-band-finish | 002#opaque-floor-band | 아래 head 2.80·위 sill 3.32 창 쌍 구간의 외향 석재 면 |
| frame-coated | 002#coated-metal | 창호 frame·shade-box·hem, 문 hardware, 실내 계단 난간, 가구 metal 다리·손잡이, 등기구 trim |
| steel-satin, mirror-proxy | 002#exposed-steel | 수전·싱크·hob ring·손잡이·stringer, 욕실·powder 거울 |
...
| oak-furniture, walnut-furniture | 004#furniture-wood | 식탁·coffee table·desk·침대·의자 목재부·sofa plinth |
| oak-stair | 004#stair-wood | tread·riser·half-landing |
| wood-end/<목재 마감> | 004#wood-end-faces | grain 축이 법선과 평행한 끝면 |
| plaster-paint | 005#plaster-paint | plaster lining·stair-lining·ceiling, 층 owner 내벽 body·junction·계단 구멍 절단면 |
| felt-panel | 005#felt-panels | 작업실 lining |
| textile-linen·green·blue·white | 005#textiles | 소파·의자 cushion, 침구, rug |
| screen-fabric | 005#screen-fabric | shade panel |
| wet-tile | 006#wet-tile | 세 습식 방의 바닥판과 powder·욕실 lining |
...
| retained/<현재 material id> | 006#retained-surfaces | 식재·토양·대지 포장·기기·소품·glow와 새 마감이 없는 역할 |
...
두 마감이 만나는 곳은 실제 형상의 경계다. 공유 벽은 양쪽 방 lining이 각자 마감을 받고(예: 현관 plaster/작업실 felt, 복도 plaster/욕실 tile), 문턱은 oak 바닥과 tile 바닥이 문 아래에서 나뉜다. 층간 띠는 같은 석재 패널 안의 도장 경계, 공용부 전면벽의 junction 띠는 lining과 같은 도장이다. 같은 면에 서로 다른 두 사후 칠하기 owner를 두지 않는다.
