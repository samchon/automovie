 ...
 * @evidenceReview spaces/junctions.md #c59c8e2 # 외벽 접합 파일의 대각 평면을 north/west/east/southWest/southEast 다섯 윤곽으로 내고 다른 접합 치수는 아래 exports에 둔다.
 ...
 * @evidenceReview spaces/junctions.md #c59c8e2 # 외벽 석재 단면 수치만 이 상수가 내고 대각 벽 윤곽과 T 접합은 같은 파일의 다른 exports가 계산한다.
 ...
 * @evidenceReview spaces/junctions.md #c59c8e2 # 내부 T 접합의 끝선 값 자체는 templeInteriorWallEnds가 내고 이 함수는 그 네 수치로 plan polygon을 형성한다.
 ...
 * @evidenceReview spaces/junctions.md #c59c8e2 # 내부 spine·제실 남벽·업무방 가로벽과 현관 반환부의 접합 값을 별도 이름으로 내어 WallRect 소비자가 한 기준선을 공유한다.
