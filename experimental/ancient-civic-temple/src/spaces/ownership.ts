 ...
 * @evidenceReview spaces/ownership.md#surface-map #87dc34b # surfaces 키가 두 실내 owner 벽뿐이라 외부 facade와 봉헌·업무방 벽이 dado로 잘못 재소유되지 않는다.
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # height와 surfaces가 같은 객체에 있어 분할 함수가 대상 이름과 0.60m 절단선을 독립 리터럴 없이 받는다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # dado 상수는 기존 0.60m·두 owner를 그대로 담고 문 void나 다른 방의 벽을 추가로 분할하지 않아 부모의 표면 배정이 유지된다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 각 선택된 WallFace에 splitAtLevel을 적용해 원래 벽면과 dado면을 같은 경계에서 반환할 수 있다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 0.60m 같은 평면 분할만 수행해 기존 wall solid나 방 경계를 움직이지 않으므로 상위 공간 소유 결정을 고치지 않았다.
 */
