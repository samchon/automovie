 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # siteCells·ground 조각·placement zone이 같은 extent를 읽어 대지 끝선이 소비자마다 달라지지 않는다.
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # siteCells가 v.floor와 v.ceiling을 네 방향 levelCell 모두에 적용한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 수직 −0.3..6m는 기존 site-extent 예약 그대로라 건물 층 상한을 바꾸지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-scope-preservation #e4bc845 # templePlan의 yardFront·southOuter만 참조해 경사 전환에 새 하드코딩 Z를 넣지 않는다.
 * @evidence principles/core/source-units.md#source-substantive-completion 읽기 전용 튜플로 지면 평면·경계석·기단 칸이 같은 전환선에서 나뉜다.
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # as const 두 경계가 GradePlane과 gradeBands에서 공유되어 표면 경사 띠가 동일한 선에 맞는다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 두 구간 경계가 부모의 야드 앞과 남외벽 선 그대로라 지면 경사를 다시 설계하지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # middle slope=(road−service)/(south−north), constant=service−slope*north라 양 전환선에서 높이가 연속된다.
 * @evidenceExclude upstream/design/space-sources.md#design-revision-from-space-source-work site.md#site-grade의 식을 그대로 구현했다.
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 세 구간의 높이와 선형 보간식을 부모 그대로 써 경사 각도나 서비스 접점 높이를 새로 고르지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 반환 scalar를 ContactMinimum이 직접 쓰고 site support plane 역시 같은 GradePlane에서 만들어 눈높이 기초가 일치한다.
 * @evidenceExclude upstream/design/space-sources.md#design-revision-from-space-source-work site.md#site-grade의 높이 식을 그대로 쓴다.
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 이미 결정된 선형 grade를 평가할 뿐 별도 표면 높이 함수를 만들어 부모 지면을 바꾸지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 계산 결과 하나가 templeWallBottom의 outsideContactMinimum 인수로 쓰일 수 있다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 단조 grade의 건물 남북 접촉만 비교하므로 부모 외벽 접지 산식을 바꾸지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-scope-preservation #e4bc845 # 정문 개구 폭의 기준은 porch datum을 참조하고 나머지는 대지 구획선만이어서 건물 외벽 선을 재정의하지 않는다.
 * @evidence principles/core/source-units.md#source-substantive-completion as const 값으로 구획·경계석·배치 구역이 같은 선을 쓴다.
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # ground pieces·curb rect·placement zone이 하나의 SiteLines를 읽어 포장 가장자리의 기준을 공유한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 경계석·골목·거리·서비스 apron 수치가 기존 site-paving 표와 같고 새 접근로를 늘리지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 네 바깥 끝이 PlanRectangle 한 개로 나와 paving street·lane 경계가 같은 curb 외측을 참조한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 부모의 0.3m 경계석 폭만 적용해 포장 구획의 바깥 둘레를 새로 고르지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 남·서·동·북 lane 범위가 단일 PlanRectangle이어서 ground pieces와 placement zones가 동일한 포장 가장자리를 받는다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 골목 3m와 거리 8m를 부모 포장 계획대로 외측에만 더해 대지 연결의 방향을 바꾸지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-scope-preservation #e4bc845 # 배열 요소에는 id·allows·rect만 있고 실제 집 mesh나 나무 instance는 없다.
 * @evidence principles/core/source-units.md#source-substantive-completion ID·허용 목록·범위를 가진 목록으로 후속 배치가 같은 구역을 쓴다.
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 각 예약에 안정 ID와 허용 종류 및 네 좌표가 있어 후속 instances가 구역을 다시 고르지 않아도 된다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 포장 밖 1.5m 물러남과 네 배치 구역만 정의해 부모가 예약한 대지 조경 범위를 늘리지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # instances가 한 상수에서 풀 띠와 포장 금지 여유를 함께 읽을 수 있어 별도 배치 폭 선택이 없다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 두 폭을 기존 placement-zones 그대로 받았고 실제 풀 배치를 앞당기지 않아 부모 규칙을 수정하지 않았다.
 */
