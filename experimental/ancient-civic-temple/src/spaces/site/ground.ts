 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # SitePiece.surface와 surface.site.<종류> 생성 모두 이 세 토큰을 사용한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 세 재료 영역의 설계상 owner 이름만 타입화했고 개별 포장재 부재를 공간층으로 끌어오지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # groundFaces와 siteSupports가 동일 SitePiece의 id·surface·rect를 받아 면과 지지 ID를 묶는다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 부모의 구획표가 가진 세 필드만 타입에 올리고 새 네 번째 측량값을 요구하지 않았다.
 */
export interface TempleSitePiece {
   ...
   * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # templeSiteSupports의 template literal이 piece.id를 그대로 사용해 경사 분할 뒤에도 원 구획이 식별된다.
   ...
   * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 구획 이름은 site-paving의 행 ID를 소비하므로 별도 지형 분류 체계를 도입하지 않았다.
   */
  id: string;
  /**
   ...
   * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # groundFaces가 piece.surface를 surface.site.* ID로 옮겨 열여섯 조각의 마감 owner를 구분한다.
   ...
   * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # earth/paving/ground 세 구획 분류가 부모의 흙·포장·이웃 바닥과 일치해 표면 소유를 바꾸지 않았다.
   */
   ...
   * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # rect를 GradeBands에 넘겨 Z 전환선에서만 추가 밴드를 만드는 평면 입력이다.
   ...
   * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 사각 범위를 부모 구획표에서 받아 지면 경사 분할 외의 새로운 필지 조각을 만들지 않았다.
   */
  rect: PlanRectangle;
}
 ...
 * @evidenceReview principles/core/source-units.md#source-scope-preservation #e4bc845 # 반환 배열은 열여섯 PlanRectangle뿐이고 cobble 개별 mesh 또는 추가 골목 조각을 생성하지 않는다.
 * @evidence principles/core/source-units.md#source-substantive-completion 조각 목록을 돌려줘 지면 면과 support가 같은 구획을 쓴다.
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # GroundFaces와 Supports가 이 동일한 조각 목록을 순회해 surface와 보행 지지가 같은 rect에서 나온다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 기존 열여섯 영역의 네 끝선을 사용했고 지면 포장 패턴을 spaces가 새로 정하지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 여섯 PlanRectangle이 curb 내부·외부 선 사이의 폭을 유지한 채 닫힌 띠 조립 입력을 제공한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 부모가 지정한 정문과 서비스 문 앞 두 틈만 두어 접근 경로를 막는 새 경계석을 더하지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 각 slice의 north/south와 대응 HeightPlane이 함께 반환되어 윗면 네 꼭짓점이 같은 평면식을 따른다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 기존 yardFront·southOuter 두 전환에서만 나눠 부모의 세 구간 경사 외 새 등고선을 도입하지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 각 band의 grade plane을 네 X/Z 꼭짓점에 평가하고 뒤집힌 winding의 WallFace를 한 장씩 낸다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 포장과 이웃 바닥을 닫힌 토막 체적으로 만들지 않아 부모의 열린 지면 표현을 보존했다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 열여섯 원구획을 경사 밴드로 분해한 후 각 윗면이 site-ground model에 결속될 목록으로 나온다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 세 종류 owner만 출력하고 새로운 fourth paving 표면을 만들지 않아 부모 site-paving 소유가 유지된다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 각 사각의 경사 밴드를 높이 양끝 prism으로 닫고 겹친 수직 접면을 지워 curb model의 외부 면만 반환한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 경계석의 지면 아래 0.10m·위 0.12m 단면은 부모 높이에서 왔고 새로운 차도 턱 높이를 고르지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 각 built surface에 support.site ID, band polygon, slopeX/Z와 originHeight가 있어 supportHeight가 관찰 눈높이를 재구성한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 부모의 구획 rect와 세 구간 grade plane만 support로 내어 별도 보행 지형을 발명하지 않았다.
 */
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 반환값이 surface.id 문자열 배열이라 environment.walkable에 실제 support ID를 그대로 결속한다.
 ...
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 이웃 ground.*만 보행 목록에서 빼 부모가 정한 흙띠·포장 접근 범위를 유지했다.
 */
