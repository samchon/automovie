 ...
 * @evidenceReview spaces/site.md #df1874e # SiteIds는 unit과 space를 temple-site로, 단독 뿌리 element를 site.root로 지정한다.
 * @evidence spaces/site.md#site-extent 대지를 건물과 다른 소유 단위 temple-site로 주소화한다.
 * @evidenceReview spaces/site.md#site-extent #e28a3d7 # building unit과 space ID가 temple-site라 건물 temple의 자식 방으로 대지를 넣지 않는다.
 ...
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # 조립 함수와 site 관찰·connector가 같은 temple-site 문자열을 재사용할 단일 식별자 객체다.
 ...
 * @evidenceReview spaces/site.md #df1874e # TempleSite에는 별도 unit·space, 세 model·element와 보행 support·walkable 목록의 여섯 필드가 있다.
...
export interface TempleSite {
   ...
   * @evidenceReview spaces/site.md #df1874e # unit 필드가 temple-site id·site.root element·temple-site space를 결합한 IAutoMovieBuildingUnit을 받는다.
   ...
   * @evidenceReview spaces/site.md #df1874e # space 필드에 건물 직사각형 바깥 네 방향 levelCell을 가진 exact site 공간이 들어간다.
   ...
   * @evidenceReview spaces/site.md #df1874e # models 배열은 site-ground·site-curbs·site-distant 세 surfaceModel의 결과다.
   ...
   * @evidenceReview spaces/site.md #df1874e # elements 배열에는 site.root 하나와 세 site model 각각을 가리키는 element가 있다.
   ...
   * @evidenceReview spaces/site.md #df1874e # supports 필드는 SitePieces의 지면 구획에서 생긴 floor support 배열을 받으며 경계석 prism의 top은 별도다.
   ...
   * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # plane 높이의 built surface 목록이 site 관찰의 supportHeight와 접근 connector의 지면 높이 입력이 된다.
   ...
   * @evidenceReview spaces/site.md #df1874e # walkable 필드는 templeSiteWalkable이 support에서 earth·paving ID만 뽑은 결과다.
 ...
 * @evidenceReview spaces/site.md #df1874e # createTempleSite가 별도 unit·네 cell space·세 surfaceModel·네 element·support 및 walkable ID를 한 결과에 조립한다.
