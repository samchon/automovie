 ...
 * @evidenceReview spaces/rooms/entrance.md #863df7e # EntranceSteps의 세 값 1.8·0.35·0.12m가 현관 두 단의 폭·디딤·상승을 그대로 지정한다.
 ...
 * @evidenceReview spaces/rooms/entrance.md #863df7e # Floors의 first-tread·upper-landing·west-support·east-support 네 구획에서 둘째 디딤과 참은 별도 경계 없이 같은 상부참이다.
 ...
 * @evidenceReview spaces/rooms/entrance.md #863df7e # Floor가 네 현관 구획과 문 passage를 묶고 southOuter에 닿은 slab만 exteriorBottom으로 늘려 접지부를 연결한다.
 ...
 * @evidenceReview spaces/rooms/entrance.md #863df7e # 반환되는 entrance 공간 하나가 네 구획의 roofedCells와 후퇴벽 door passage의 thresholdCells를 함께 가진다.
 * @evidence spaces/rooms/entrance.md#entrance-volume 각 구획의 실제 완성면을 cell 하한으로, 합성 포치 지붕 하부를 상한으로 써서 석재 내부를 공간에 넣지 않는다.
 * @evidenceReview spaces/rooms/entrance.md#entrance-volume #154a129 # roofedCells마다 region.floor가 하한이고 porch tier patch가 상한이라 낮은 첫 디딤 높이를 옆 받침에 복사하지 않는다.
