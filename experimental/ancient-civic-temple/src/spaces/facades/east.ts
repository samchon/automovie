 ...
 * @evidenceReview spaces/facades/east.md #d87cf4d # 동측 외벽을 한 WallSpec으로 내고 service-yard, storage, records, administration과 남동 칸에 서로 다른 segment 상단을 매긴다.
 * @evidenceReview spaces/facades/east.md#east-envelope #e1ad78f # 북측 마당 구간은 templeYardWallTop, 세 업무방은 wing roof 하부, south-inner~outer 칸은 templeParapetTop을 써 높이 변화를 원본 구간대로 낸다.
 * @evidenceReview principles/core/source-units.md#source-scope-preservation #e4bc845 # 외부 문 void는 templeDoorVoidsOn에서 받고 마당·코핑 상단은 north/south 소유 상수라 이 export가 새 높이나 두 번째 문을 만들지 않는다.
 * @evidenceReview principles/core/source-units.md#source-substantive-completion #e9c974f # wall.facade-east의 plan, bottom, nine segments, 서비스 void와 세 top 정책을 모두 채워 wallFaces 입력으로 바로 쓸 수 있다.
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work #d9ad066 # 낮은 마당 벽에서 동측 박공 하부로 바뀌는 yard-front와 서비스 문 경계를 원본에 대조했고 self-check 겹침 0에서 부모 높이 수정을 요구하는 충돌이 없었다.
 */
