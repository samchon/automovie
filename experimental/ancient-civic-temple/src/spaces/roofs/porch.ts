 ...
 * @evidenceReview spaces/roofs/porch.md #f9de320 # 두 반환벽 안쪽 사이의 독립 tier porch 박공을 생성하고 전면 처마만 건물 외곽 밖으로 내민다.
 * @evidenceReview spaces/roofs/porch.md#porch-roof #ec83370 # westPorchInner~eastPorchInner가 옆 처마 없는 폭이고 entranceBack부터 southOuter+0.35까지라 후퇴벽이 뒤끝, 앞 돌출이 정면이 된다.
