 ...
 * @evidenceReview spaces/roofs/west.md # 봉헌실 전 길이와 서쪽 주랑을 같은 roof-west 후보로 내고 제실 몸체 영역을 두 후보 사이에서 비운다.
 * @evidenceReview spaces/roofs/west.md#west-roof # westCourt 3.20m에서 서쪽으로 12도 올라가 westInner에서 끝나며 중정 쪽만 0.35m 돌출하고 북·남·서 파라펫 쪽은 돌출하지 않는다.
 * @evidenceReview principles/core/source-units.md#source-scope-preservation # leanToPlanes의 높이는 rules.courtEave/leanSlope를 쓰고 두 영역 끝은 templePlan 선이라 제실 위 후보를 추가하지 않는다.
 * @evidenceReview principles/core/source-units.md#source-substantive-completion # 봉헌실과 주랑 두 rectanglePolygon을 각자 roof plane과 두께로 바꿔 westInner 약 4.56m의 날개 후보가 비어 있지 않다.
 * @evidenceExcludeReview upstream/design/space-sources.md#design-revision-from-space-source-work # parent의 westInner~westRoom 봉헌실과 westRoom~westCourt 주랑 두 후보를 인자에 맞췄고 코핑을 넘는 상면은 나오지 않았다.
 */
