/**
 * The 76 object roles in the temple inventory, placed in room-local world metres.
...
export class TempleObjectInstances {
  static placements(): TempleObjectPlacement[] {
    ...
    put(e,"washing-bowl","offering-bowl",-1.35,0.46,9.53);
    ...
    put(s,"offering-bowl","offering-bowl",-0.55,1.10,-7.35);
    ...
    put(o,"offering-bowl","offering-bowl",-7.70,0.82,-1.65);
    ...
    put(a,"stylus","stylus",7.50,0.765,7.28);
    ...
    put(r,"stored-scroll","scroll",7.20,0.45,2.30);
    ...
    put(st,"storage-jar","storage-jar",6.75,0,-1.30);
    put(st,"carry-jar","carry-jar",7.50,0,-1.35);
    ...
    if (list.length !== 76) throw new Error(`사물 역할 ${list.length}/76`);
    return list;
  }
