...
<!--
@evidence principles/core/common.md#scope-preservation 제단의 상판·두 지지부·봉헌 그릇과 제실의 접근/등잔 간격 소비를 연결한다.
@evidence principles/core/common.md#substantive-completion 폭·깊이·높이·상판 두께 범위와 자립 지지 관계를 정해 얇은 판 대체를 막는다.
@evidence principles/core/common.md#declared-basis 이미지 02·04와 제실 요구를 따르며 수치 치수는 저작자 허용 범위다.
@evidence principles/core/settings.md#fact-status 석단 상면 기준 0.85~1.05m는 저작 입력이지 발굴 제단 실측치가 아니다.
@evidence principles/core/settings.md#source-support 두꺼운 석재 제단의 근거를 02·04에 두고 특정 의례나 유물의 출처를 발명하지 않는다.
@evidence principles/core/settings.md#capability-boundary 얕은 그릇을 올리는 자립 물체로 한정하고 사람 형상·글자·현대 장식은 넣지 않는다.
@evidence principles/core/settings.md#constraint-sufficiency 폭 1.2~1.6m·깊이 0.6~0.9m·상판 0.10~0.16m 범위에서 모델이 치수를 정한다.
@evidence principles/core/settings.md#observable-identity 옅은 돌의 두꺼운 직사각 상판과 분리되어 읽히는 양측 받침이 제단의 중심 형태다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 상판과 두 지지부에 그릇·제실 접근 관계가 더해져 덩어리 하나만 놓는 제단이 아니다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 상판 두께까지 범위를 줘 통행을 맞추기 위한 얇은 판 대체를 거부할 수 있다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 02·04의 두꺼운 형상과 사용자 제실 요구를 받은 뒤 수치는 저작자가 선택하도록 분리했다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 0.85~1.05m의 기준은 석단 상면이며 실측 제구 규격을 복원한 값으로 기술하지 않는다.
@evidenceReview principles/core/settings.md#source-support #430bca9 제공 이미지의 석재 상판·받침을 근거로 삼되 특정 유물 명칭이나 의례 자료를 발명하지 않았다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 봉헌 그릇을 받치는 자립 물체이고 사람 형상·글자를 추가할 권한은 없다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 폭·깊이·상판 두께 범위와 공간 접근의 후속 소유가 있어 방에 맞추며 물체 기준을 잃지 않는다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 상판 가장자리와 양측 받침이 분리되어 보여야 하므로 돌 상자와 같은 실루엣으로는 부족하다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 공동 봉헌용 긴 돌 탁자의 받침·상판·그릇·빈 여백을 소유한다.
@evidence principles/core/common.md#substantive-completion 높이 0.7~0.9m·깊이 0.65~0.85m·길이 1.8~2.4m로 제단과 다른 사용 비례를 정한다.
@evidence principles/core/common.md#declared-basis 이미지 02의 탁자를 참고한 저작자 치수와 일상 용도 선택이다.
@evidence principles/core/settings.md#fact-status 탁자의 낮고 긴 비례는 채택 형상이며 역사 제구의 규격이라고 말하지 않는다.
@evidence principles/core/settings.md#source-support 공동 봉헌실 reference 02에서 형태 근거를 가져오고 사진 비례로 길이를 재지 않는다.
@evidence principles/core/settings.md#capability-boundary 양옆에서 작은 소품을 놓는 용도로 제한하고 제실의 높은 제단 역할을 대신하지 않는다.
@evidence principles/core/settings.md#constraint-sufficiency 그릇이 상판에 놓이고 빈 여백·상판 아래가 보여 물체가 탁자를 완전히 가리지 않게 한다.
@evidence principles/core/settings.md#observable-identity 두 다리받침과 약하게 닳은 긴 석재 상판으로 낮은 공용 봉헌대를 식별한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 받침·상판 아래와 상판 위 빈 여백을 모두 요구해 그릇에 가려진 탁자를 납품하지 않는다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 낮고 긴 치수 범위와 양옆 사용을 정해 제단과 같은 용도의 짧은 돌덩어리가 되지 않는다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 02가 공용 탁자의 참고이고 길이·깊이·높이는 저작자 결정으로 표시돼 있다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 1.8~2.4m는 이 제작의 허용 길이이며 고대 제구의 표준 치수로 일반화하지 않는다.
@evidenceReview principles/core/settings.md#source-support #430bca9 02의 긴 석재 탁자와 본문이 대응하나 이미지 비례에서 수치를 측정했다고 하지 않았다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 작은 소품을 양옆에서 놓는 일상 용도를 제단과 구분해 제실 중심 물체를 대체할 수 없다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 그릇은 상판에 접하고 빈 여백을 남겨야 하므로 임의 떠 있는 소품으로 구성하지 않는다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 두 다리받침 아래가 보이고 테두리가 약하게 닳은 긴 돌 탁자가 공용 봉헌대의 표지다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 발·줄기·접시·금속 마모와 제단 양측 배치의 후속 소유를 다룬다.
@evidence principles/core/common.md#substantive-completion 높이 0.9~1.3m와 발/접시 지름 0.18~0.3m, 불꽃 없는 상태를 정한다.
@evidence principles/core/common.md#declared-basis 이미지 02·04의 금속 등잔대를 바탕으로 저작자가 크기를 제한한다.
@evidence principles/core/settings.md#fact-status 높은 자립 등잔대는 채택 물체이며 유물 치수나 실제 연소 성능의 결과가 아니다.
@evidence principles/core/settings.md#source-support 어두운 세로 등잔대와 상부 접시의 자료를 두 reference로 특정한다.
@evidence principles/core/settings.md#capability-boundary 등잔은 불꽃을 내지 않으며 배치 수·접지·기울지 않는 위치는 instances에서 정한다.
@evidence principles/core/settings.md#constraint-sufficiency 발과 접시를 작은 지름으로 제한해 제단보다 과대한 부재가 되지 않게 한다.
@evidence principles/core/settings.md#observable-identity 넓어진 낮은 발·좁은 줄기·얕은 원형 접시의 위계와 닳은 금속 가장자리가 읽혀야 한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 발·줄기·접시뿐 아니라 접지와 제실 배치의 소유까지 있어 세로 막대만 세우고 끝내지 않는다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 높이와 발/접시 지름, 불꽃 없는 상태를 함께 정해 크기와 작동 상태를 결정했다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 02·04의 어두운 등잔대와 저작자가 정한 높은 자립형의 치수 범위가 각각 근거로 적혀 있다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 자립 부재의 외형을 정했을 뿐 전도나 연소 시험을 끝냈다는 결과는 없다.
@evidenceReview principles/core/settings.md#source-support #430bca9 세로 줄기 위 얕은 접시를 이미지에서 확인할 수 있으며 금속 성분이나 유물 치수를 추정하지 않는다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 불꽃이 없다는 본문은 어두운 실내를 등잔 광원으로 채우는 변경을 허용하지 않는다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 0.18~0.3m 지름과 0.9~1.3m 높이를 함께 제한해 과대한 접시가 제단을 압도하지 않게 한다.
...
<!--
@evidence principles/core/common.md#scope-preservation 관리실 작성과 기록실 열람의 책상·스툴·인출 여백을 함께 정한다.
@evidence principles/core/common.md#substantive-completion 상판·네 다리·가로 지지재와 책상/좌석 높이 범위를 주어 사용 집기의 비례를 결정한다.
@evidence principles/core/common.md#declared-basis 이미지 05의 작업 장면을 근거로 저작자가 스툴 통일과 치수 범위를 채택한다.
@evidence principles/core/settings.md#fact-status 좌석 0.42~0.48m는 물체 설계값이며 인체공학 인증이나 인물 앉기 검증이 아니다.
@evidence principles/core/settings.md#source-support 현대 가구 규격을 인용하지 않고 reference와 저작 수치를 구별한다.
@evidence principles/core/settings.md#capability-boundary 작성·열람용 정지 집기로 쓰고 앉는 인물 동작이나 현대 레일·바퀴·쿠션은 납품하지 않는다.
@evidence principles/core/settings.md#constraint-sufficiency 책상 높이 0.7~0.8m·폭 0.9~1.3m·깊이 0.5~0.7m와 통로 쪽 좌석 여백을 지정한다.
@evidence principles/core/settings.md#observable-identity 어두운 목재 상판·다리·횡재가 구분된 책상과 단순 스툴이 작은 업무 공간을 구성한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 관리실 작성과 기록실 열람 모두 같은 가구 계열을 쓰고 통로 쪽 좌석 인출 여백도 남긴다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 좌석은 스툴로 통일하고 책상 상판·네 다리·횡재를 정해 선택하지 않은 의자 유형을 뒤로 미루지 않았다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 05의 작업 가구를 참고하되 스툴 통일과 수치 범위는 저작자의 선택으로 구별된다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 좌석 높이는 물체 설계 조건이고 사람의 앉기 동작은 범위 밖이므로 인체 적합성 시험 결과가 아니다.
@evidenceReview principles/core/settings.md#source-support #430bca9 0.42~0.48m를 현대 가구 표준에서 인용했다고 하지 않아 외부 인증 수치를 꾸미지 않는다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 현대 레일·바퀴·쿠션은 없으며 가구의 정지 배치가 인물 수행으로 확대되지 않는다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 책상 폭·깊이·높이와 스툴 높이를 함께 정해 물체 비례를 설정 없이 자유롭게 늘리지 못한다.
...
<!--
@evidence principles/core/common.md#scope-preservation 기록실의 두루마리 칸과 봉헌실의 낮고 넓은 그릇 칸을 같은 선반 계열 안에서 구분한다.
@evidence principles/core/common.md#substantive-completion 높이 1.2~1.8m·깊이 0.25~0.45m, 물건 아래 지지판과 벽 비매몰을 정한다.
@evidence principles/core/common.md#declared-basis 이미지 02·05를 참고해 방별 칸의 용도와 치수 범위를 저작자가 선택한다.
@evidence principles/core/settings.md#fact-status 지지 방식은 물체 크기·접근에 맞출 설계 대상이며 하중 검증이 끝난 선반으로 제시하지 않는다.
@evidence principles/core/settings.md#source-support 목재 보관대의 시각 자료는 02·05이고 특정 목재 구조 규격이나 내하력은 주장하지 않는다.
@evidence principles/core/settings.md#capability-boundary 수평 두루마리와 그릇을 지지하되 벽 속에 묻히거나 근거 없는 하중 장식으로 처리하지 않는다.
@evidence principles/core/settings.md#constraint-sufficiency 길이·칸 수·지지 방식은 모델/배치가 물체 크기와 접근을 보고 정하도록 범위를 둔다.
@evidence principles/core/settings.md#observable-identity 두꺼운 측판과 수평 칸의 깊이가 보여야 하며 작은 다단 기록 칸과 넓은 봉헌 칸이 구별된다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 기록실 작은 다단 칸과 봉헌실 넓은 낮은 칸을 함께 지정해 한 방의 선반이 다른 방 요구를 삼키지 않는다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 판이 물건 아래에 있고 벽에 묻히지 않아야 한다는 지지 관계가 단순 수납 명칭을 넘어선다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 02·05의 보관대를 받은 뒤 방별 칸과 치수 범위는 저작자가 결정했다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 지지 방식은 물체 크기와 접근에 맞출 설계 대상이며 하중을 검증한 결과로 서술하지 않는다.
@evidenceReview principles/core/settings.md#source-support #430bca9 목재 칸의 형태는 reference와 대응하지만 내하력이나 역사 목구조 규격의 출처는 주장하지 않았다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 두루마리를 수평으로 놓고 그릇을 받치는 역할이며 무근거 하중 장식으로 지지를 대신할 수 없다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 높이·깊이는 제한하고 길이·칸 수는 접근과 물체 크기에 종속시켜 반복 수량의 결정 조건을 준다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 내부 깊이·측판·수평 칸이 보이고 기록 칸과 그릇 칸의 비례가 달라 평면 문양 선반을 거부한다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 닫힌 묶음과 책상 위 일부 펼친 한 장, 기록실/관리실의 다른 배치 밀도를 소유한다.
@evidence principles/core/common.md#substantive-completion 지름 0.04~0.08m·길이 0.2~0.35m와 말린 가장자리·끈·색을 정한다.
@evidence principles/core/common.md#declared-basis 이미지 02·05의 문서 물체를 따르고 수치와 글자 부재는 저작자가 결정한다.
@evidence principles/core/settings.md#fact-status 문서의 형상만 채택하며 실제 역사 본문이나 개인정보를 담은 기록이라고 하지 않는다.
@evidence principles/core/settings.md#source-support reference의 말린 재료를 근거로 하되 가짜 역사 문구를 만들어 출처 있는 문서처럼 보이지 않게 한다.
@evidence principles/core/settings.md#capability-boundary 문서 내용을 읽는 기능은 없고 규칙 있는 선반 수량/간격과 관리실 소량 표시는 instances가 정한다.
@evidence principles/core/settings.md#constraint-sufficiency 닫힌 원통 묶음과 일부 펼친 상태를 구분하고 돌·나무토막으로 보이는 대체를 거부한다.
@evidence principles/core/settings.md#observable-identity 황백/옅은 갈색의 원형 단면, 말린 가장자리와 묶음 끈이 저장 문서로 읽혀야 한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 닫힌 묶음과 일부 펼친 한 장을 함께 포함해 기록실 저장만 있고 관리실 작성물은 없는 누락을 막는다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 지름·길이와 끈·말린 가장자리를 정해 원통을 어떤 물체로 읽어야 하는지 완결한다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 02·05의 문서 외형과 저작자가 정한 수치·본문 부재를 분리해 읽었다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 역사 문구나 개인정보를 담지 않아 형상 재현을 기록 내용의 사실성으로 오인하지 않는다.
@evidenceReview principles/core/settings.md#source-support #430bca9 이미지에서 말린 재료 형태를 취하되 읽을 수 있는 실제 문서가 제공됐다고 꾸미지 않는다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 선반 반복과 관리실 소량 표시는 instances가 소유하고 문서 열람 내용 생성 기능은 약속하지 않는다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 닫힌 원통과 펼친 상태를 구분하고 돌·나무토막처럼 보이는 대체를 거부하므로 색만 맞춘 원기둥은 부족하다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 황백/옅은 갈색의 말린 가장자리와 묶음 끈이 문서 정체성을 지탱하며 방의 다른 도기와 구별된다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 판 몸체·분리 뚜껑·경첩·전면 걸쇠와 바닥 배치 상태를 함께 정한다.
@evidence principles/core/common.md#substantive-completion 폭 0.6~1.0m·깊이/높이 0.4~0.6m의 닫힌 표시 모델로 물체를 확정한다.
@evidence principles/core/common.md#declared-basis 이미지 05의 궤를 근거로 저작자가 치수 범위와 닫힘 기본 상태를 정한다.
@evidence principles/core/settings.md#fact-status 잠금 장치가 보이는 표현이며 실제 자물쇠 작동이나 내용물의 존재를 입증한 것이 아니다.
@evidence principles/core/settings.md#source-support 시각 근거를 서비스 구역 이미지 05로 한정하고 유물 제작법이나 잠금 성능을 외삽하지 않는다.
@evidence principles/core/settings.md#capability-boundary 뚜껑 열림 애니메이션과 내용물의 숨은 공간을 납품하지 않는다.
@evidence principles/core/settings.md#constraint-sufficiency 바닥에 놓인 닫힌 궤에서 뚜껑 두께가 읽혀야 하며 분리된 판 구성이 유지되어야 한다.
@evidence principles/core/settings.md#observable-identity 직사각 목재 판 몸체 위 별도 뚜껑과 전면 금속 걸쇠가 단순 목재 블록과 구별한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 몸체·뚜껑·경첩·전면 걸쇠 모두 명시돼 목재 상자 외형만으로 잠금 궤를 대신할 수 없다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 닫힌 바닥 배치와 열림/내용물 제외를 끝내 물체 내부 제작 범위가 미정으로 남지 않는다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 05의 궤를 참고한 뒤 크기와 기본 상태는 저작자 결정으로 표기했다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 걸쇠는 보이는 표현이며 실제 잠금 작동이나 내부 내용물을 입증하는 주장은 없다.
@evidenceReview principles/core/settings.md#source-support #430bca9 05에서 보이는 분리 뚜껑과 철물을 근거로 삼으며 유물 제작법·잠금 성능으로 확대하지 않는다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 열림 애니메이션과 내용물의 숨은 공간은 납품하지 않아 보관실에 새로운 관찰 공간이 생기지 않는다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 폭·깊이·높이를 주고 뚜껑 두께를 실체로 요구해 잠금 장식만 붙인 블록을 거부한다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 판으로 짠 몸체와 분리 뚜껑·전면 금속 걸쇠가 낮은 궤를 단순 탁자나 나무 덩어리와 구별한다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 작은 탁상 용기·큰 저장 용기·얕은 봉헌 그릇의 형태군을 모두 지정한다.
@evidence principles/core/common.md#substantive-completion 배·목·입술·열린 입·붙은 손잡이와 크기군으로 용기 종류를 완결한다.
@evidence principles/core/common.md#declared-basis 다섯 이미지에 보이는 용기를 따르고 높이·지름 범위는 저작자가 정한다.
@evidence principles/core/settings.md#fact-status 외형 크기와 무광 재료는 채택 입력이며 실제 용량·액체 무게는 보증하지 않는다.
@evidence principles/core/settings.md#source-support 도기/그릇의 모양은 사용자 이미지에서 취하고 고대 도자기 분류나 제조법을 주장하지 않는다.
@evidence principles/core/settings.md#capability-boundary 열린 입과 오목한 그릇을 표현하지만 색만 바꾼 구체·상자를 용기 대신 쓰지 못한다.
@evidence principles/core/settings.md#constraint-sufficiency 작은 높이 0.12~0.3m·큰 높이 0.45~0.8m·그릇 지름 0.15~0.3m로 상대 규모를 묶는다.
@evidence principles/core/settings.md#observable-identity 적갈색 도기의 부푼 배와 좁은 목, 두꺼운 테두리의 얕은 금속/도기 그릇이 서로 구별된다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 탁상 용기·저장 항아리·얕은 봉헌 그릇을 모두 다뤄 한 도기 크기를 모든 방에 복제할 수 없다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 바닥·배·목·입술·열린 입과 붙은 손잡이를 결정해 용기의 형태를 단순 색 이름에 맡기지 않았다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 다섯 이미지의 용기에서 형태를 취하고 크기군 범위는 저작자 결정으로 정했다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 외형 치수와 실제 용량·액체 무게의 보증을 분리해 그릇 크기로 적재 성능을 추정하지 않는다.
@evidenceReview principles/core/settings.md#source-support #430bca9 도기와 얕은 그릇의 이미지 근거는 있으나 특정 도자기 분류나 제조법을 복원했다는 주장은 없다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 열린 입과 오목한 안쪽 면을 표현해야 하므로 색 바꾼 구체·상자로 용기 종류를 대체할 수 없다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 작은 높이 0.12~0.3m와 큰 높이 0.45~0.8m가 갈려 탁상 그릇이 저장 항아리 크기로 커지지 않는다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 부푼 배·좁은 목의 항아리와 두꺼운 테두리·오목한 면의 그릇은 서로 다른 실루엣을 가진다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 원형 몸체·테두리·바닥·짜임과 보관실/서비스 마당 배치 역할을 다룬다.
@evidence principles/core/common.md#substantive-completion 지름 0.3~0.5m·높이 0.25~0.4m 및 실제 테두리/벽 두께를 정한다.
@evidence principles/core/common.md#declared-basis 이미지 02·05의 바구니를 근거로 저작자가 geometry와 미세 짜임의 분담을 결정한다.
@evidence principles/core/settings.md#fact-status 황갈색 짠 몸체는 제작 외형이며 식물 섬유 종류나 역사적 짜기 기법의 고증이 아니다.
@evidence principles/core/settings.md#source-support reference의 짠 바구니를 형태 자료로 사용하고 전면 사진을 붙여 재현했다고 주장하지 않는다.
@evidence principles/core/settings.md#capability-boundary 운반물로 배치하되 통로를 가리지 않으며 실제 적재 하중을 입증하는 물체로 쓰지 않는다.
@evidence principles/core/settings.md#constraint-sufficiency 미세 짜임 방식만 리뷰 거리에서 모델이 정하고 둥근 테두리와 벽 두께는 입체로 유지한다.
@evidence principles/core/settings.md#observable-identity 황갈색 원형 몸체의 작은 짜임 간극·둥근 테두리·바닥이 판에 붙인 그림과 구별되어야 한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 테두리·벽·바닥과 짜임 간극에 배치 역할까지 있어 표면 무늬만으로 바구니를 끝내지 않는다.
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 지름·높이와 반드시 입체일 부분을 정해 미세 짜임 표현만 후속 모델의 선택으로 남겼다.
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb 02·05가 형태 자료이고 geometry/미세 표현 분담은 저작자 선택이라고 구별된다.
@evidenceReview principles/core/settings.md#fact-status #93a284a 황갈색 짜임은 보이는 정체성으로만 제시되며 식물 섬유 종류·역사 기법의 고증을 주장하지 않는다.
@evidenceReview principles/core/settings.md#source-support #430bca9 제공 이미지의 바구니를 참고하되 그 전면 사진을 붙이는 재현은 본문에서 직접 거부한다.
@evidenceReview principles/core/settings.md#capability-boundary #83a6f2c 운반물로 배치하더라도 통로를 가릴 수 없으며 실제 적재 하중은 이 외형 단위의 약속이 아니다.
@evidenceReview principles/core/settings.md#constraint-sufficiency #20cf612 테두리와 벽 두께는 geometry라는 하한이 있어 리뷰 거리 이유로 모든 입체를 평판으로 줄이지 못한다.
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 둥근 테두리·원형 몸체·작은 짜임 간극을 요구해 도기 항아리를 황갈색으로 칠한 대체와 구별된다.
-->
...
<!--
@evidence principles/core/common.md#scope-preservation 이동식 소형 등잔: 이동식 소형 등잔의 정체성과 정문·중정·봉헌실·관리실 사용, 후속 배치 소유를 함께 정한다.
...
@evidence principles/core/settings.md#constraint-sufficiency 이동식 소형 등잔: 이동식 소형 등잔의 허용 범위와 정문·중정·봉헌실·관리실 사용 조건으로 모델과 배치가 선택할 한계를 둔다.
@evidence principles/core/settings.md#observable-identity 이동식 소형 등잔: 높은 등잔대와 구별되는 짧은 줄기와 접시라는 구분 가능한 실루엣을 요구한다.
-->

<!--
@evidenceReview principles/core/common.md#scope-preservation #24155e1 이동식 소형 등잔: 정문·중정·봉헌실·관리실에서 쓰는 물체의 정체성과 배치 소유가 본문에 있어 다른 방의 소품으로 무제한 확장하지 않는다.
...
@evidence principles/core/settings.md#observable-identity 항아리 두 자리 받침대: 두 얕은 홈이 있는 낮은 목재 상판과 네 다리라는 구분 가능한 실루엣을 요구한다.
-->
...
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 항아리 두 자리 받침대: 두 얕은 홈이 있는 낮은 목재 상판과 네 다리가 본문에 있어 용기·좌석과 구별된다.
-->
...
운반 멜대의 실제 위치와 수량은 instances가 정한다.
...
@evidence principles/core/settings.md#observable-identity 정지된 작은 손수레: 판·두 바퀴·축·뒤 손잡이가 구별되는 빈 운반대라는 실루엣을 요구한다.
-->
...
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 정지된 작은 손수레: 본문은 판·두 바퀴·축·뒤 손잡이를 빈 운반대의 구별되는 부재로 정한다. 지면 접촉은 서비스 마당과 모델에서 정한다.
-->
...
물동이의 실제 위치와 수량은 instances가 정한다.
...
@evidence principles/core/settings.md#observable-identity 글자 없는 봉헌판: 낮은 받침 위에 세운 작은 직사각 석판이라는 구분 가능한 실루엣을 요구한다.
-->
...
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 글자 없는 봉헌판: 낮은 받침 위에 세운 작은 직사각 석판이 본문에 있어 다른 집기와 구별된다.
-->
...
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 접은 직물: 제단 위 천, 작업용 천 또는 용기 덮개로 놓이는 두 겹과 접힌 가장자리가 보이는 얇은 정지 비품이다. 폭 0.4~0.6m, 깊이 0.3~0.5m, 두께 0.02~0.06m 안에서 고르고 실의 직조·봉합선은 형상이 아니다. [제실 바닥 좌구](#floor-cushion)는 이 덮개 변형에 포함하지 않는다.
...
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 글자 없는 필기판: 얕은 직사각 틀 안에 테두리보다 낮은 평평한 빈 쓰기 면이 들어간 정지 소품이다. 폭 0.24~0.35m, 깊이 0.18~0.28m이며 실제 글자·가짜 비문은 없다. 책상 위 위치와 다른 기록물과의 간격은 instances가 정한다.
...
@evidence principles/core/settings.md#observable-identity 느슨한 끈 뭉치: 가운데와 고리 사이가 빈 여러 섬유 고리와 작은 묶음 띠라는 실루엣을 요구한다.
-->
...
@evidenceReview principles/core/settings.md#observable-identity #4ccb62e 느슨한 끈 뭉치: 본문의 여러 섬유 고리와 작은 묶음 띠는 가운데와 고리 사이를 비워 단일 끈과 구별된다.
-->
...
끈 뭉치의 실제 위치와 수량은 instances가 정한다.
...
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 낮은 향로: 발·짧은 줄기·위로 열린 컵 안의 재 위로 꺼진 향이 보이는 작은 의례 비품이다. 높이 0.25~0.40m이고 제단이나 봉헌 그릇의 실루엣을 대신하지 않는다. 연기·불꽃·냄새·의례 수행은 납품하지 않는다.
