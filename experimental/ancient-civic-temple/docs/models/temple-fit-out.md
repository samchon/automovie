...
@evidenceReview spaces/temple.md#entrance-service-gate-and-route-graph #6970694 Checked that doors and furniture preserve the south threshold, room-side 1.20m protected routes, fountain landmark, and terminal service gate without creating a connector; a model-owned route edge would falsify this handoff.
...
@evidenceExclude upstream/design/models.md#settings-and-space-revision-from-model-work The reopened altar check compared the 0.82m total height, the revised 1.30m by 0.20m plinth, the revised 0.90m by 0.16m body, and the 3.60m room height; the existing sanctuary room and north observation route remain sufficient, so the interface repair belongs to this model's author-adopted depth.
...
@evidenceReview principles/design/models.md#representation-contract #46718c6 Checked two connected stacked stone parts with plinth X/Z `-0.65..0.65/-0.10..0.10m` and body X/Z `-0.45..0.45/-0.08..0.08m`; a hidden gap or a depth larger than the protected-route handoff would falsify the contract.
@evidenceReview principles/design/models.md#spatial-convention #5bbf49e Checked plinth-centred floor origin, combined X/Z `-0.65..0.65/-0.10..0.10m`, Y `0.00..0.82m`, and the source north point; mirrored, shifted, or deepened placement data would falsify this frame.
@evidenceReview principles/design/models.md#reviewable-structure #c22ab4b Checked front/side views for the 1.30m by 0.20m plinth and 0.90m by 0.16m body, plus top/three-quarter views for stacking, contact, and the north-route clearance; a broad body or route intrusion would falsify the silhouette.
...
@evidenceExcludeReview upstream/design/models.md#settings-and-space-revision-from-model-work #3e4d880 Checked the pair's 0.82m height, revised 1.30m/0.20m plinth, revised 0.90m/0.16m body, and 3.60m room fit against `sanctuary`; the parent route remains unchanged and the prior conflict was corrected in this model owner.
@evidenceReview settings/temple.md#coordinate-unit-convention #01e5537 Checked the plinth-centred Y-up origin and combined X/Z `-0.65..0.65/-0.10..0.10m`, Y `0.00..0.82m`; using `north` as a new origin or restoring the old depth would falsify this handoff.
...
@evidenceReview spaces/temple.md#room-schedule-and-direct-thresholds #e393909 Checked the existing sanctuary bounds X `-3.20..3.20m`, Z `6.00..8.40m`, north observation coordinate `7.80m`, and the model depth handoff that permits a later north-axis instance without changing the route; a new door or route edit would falsify the consumer relation.
