...
@evidence upstream/design/models.md#settings-and-space-revision-from-model-work 작업 스툴과 구별되는 제실 바닥 좌구의 settings 정체성 owner가 없어 35-objects#floor-cushion를 새로 만들고 30-interiors#sanctuary의 방 목록에 넣었다. 이 부모 수리를 마친 뒤 형상 산문을 정했다.
