...
@evidence principles/core/common.md#substantive-completion 선대 0.10m·가로대 0.10/0.10/0.16m·판 두께 0.02m, 손잡이 원환과 받침판, 핀 경첩, 바닥 0.01m 띄움이 있어 source가 문짝 구조를 새로 고르지 않는다.
...
@evidence principles/core/common.md#substantive-completion 가로 띠 높이·폭·두께, 짝 폭 0.6배 쇠 띠, 널 다섯 장 이음 홈, 손잡이 높이 1.05m가 있어 source가 판문 구조를 새로 고르지 않는다.
