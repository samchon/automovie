...
@evidence principles/design/models.md#spatial-convention 축 아래 바닥 중심 원점, 앞 +Z, 손잡이 끝의 두께를 포함한 0.76×0.72×1.82m 점유를 정한다.
...
@evidence principles/design/models.md#spatial-convention 바닥 중심 원점과 손잡이 관을 포함한 0.30×0.45×0.30m 점유를 정한다.
