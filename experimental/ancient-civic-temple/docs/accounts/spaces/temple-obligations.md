...
<!--
@evidenceReview contracts/obligations-spaces.md#surface-ownership ownership 표와 두 분할 규칙을 모든 room/입면/roof/대지와 문턱·junctions에 대조했다. 입면별 coping·plinth, 마당 wall-top, 주랑·제실의 dado가 각각 기존 owner의 한 표면으로 귀속되고 모서리 칸과 띠 경계에서도 겹치지 않는다. compiled 면의 역검사를 수행하지 않았다고 본문이 밝힌다.
-->
