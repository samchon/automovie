...
<!--
@evidence contracts/obligations-spaces.md#compiled-observations observations의 전집합 유도와 각 room/입면/roof/대지의 지역 질문, 주랑의 안쪽·현관 몸체 모서리와 접합 관찰, 연직 단면 묶음과 대각 골 단면의 unverified 기록, 제실·반환벽·후퇴벽 끝 칸의 외부 향 경계와 무효 창 threshold, reference 다섯 pose를 함께 읽고 방별 프레임 판정의 부재를 따로 기록한다.
-->

<!--
@evidenceReview contracts/obligations-spaces.md#compiled-observations #09b52ea 주랑 추가 모서리 여섯과 접합·연직 단면, 대각 골 단면의 unverified, 여섯 수평·반환벽 네 상부·후퇴벽 끝 칸 네 상부 입면과 두 포치 자유 끝, 개구부 16개 방 쪽 pose·무효 창 threshold 넷·reference 다섯을 보존한다.
-->
