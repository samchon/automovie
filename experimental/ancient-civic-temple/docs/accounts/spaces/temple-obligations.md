...
<!--
@evidence contracts/obligations-spaces.md#surface-ownership ownership 표의 입면·방·층·roof·대지 주소를 각 공간/입면/roof/대지의 실제 소유 문장과 대조했다. 공유벽의 한 실체와 양면 마감, 문턱, 박공, 처마 하부, 외벽 기단·코핑, 주랑·제실의 하부 띠, 건물과 다른 소유 단위인 대지 표면을 아래와 같이 구별하며 compiled 역검사는 아직 없음을 남긴다.
-->

<!--
@evidenceReview contracts/obligations-spaces.md#surface-ownership #1a50ebe ownership 표와 두 분할 규칙을 모든 room/입면/roof/대지와 문턱·junctions에 대조했다. 입면별 coping·plinth, 마당 wall-top, 주랑·제실의 dado가 각각 기존 owner의 한 표면으로 귀속되고 모서리 칸과 띠 경계에서도 겹치지 않는다. compiled 면의 역검사를 수행하지 않았다고 본문이 밝힌다.
-->
...
<!--
@evidenceReview contracts/obligations-spaces.md#compiled-observations #09b52ea observations와 각 지역 질문을 함께 읽었다. 고리 주랑 여섯 영역, 마당 두 문턱, 현관 단면, 대지 시점 묶음을 더하며 null·충돌 원 질문을 보조 pose로 삭제하지 않는다. census·관찰 수·RENDERER는 payload에서 유도되지만 방별 프레임 판정은 unverified로 남았다고 적는다.
-->
