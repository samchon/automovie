...
<!--
@evidenceReview obligations/core/common.md#proportionate-development #78feb28 본문의 27파일·45 H2와 아홉 표 행은 `npm run self-check -- --sync-accounts --handoffs` 출력과 일치해 불일치 0이다. 마지막 수정이 반영된 openings 6945자·observations 10165자도 그 출력에서 재생성했으며 v-077의 26파일·37 H2 비교는 별도 문단에 남는다.
-->
...
| ownership·observations | 2/4 | 3860·10165 |
| site | 1/6 | 5518 |
