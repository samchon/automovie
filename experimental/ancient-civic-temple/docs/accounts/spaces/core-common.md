...
<!--
@evidenceReview obligations/core/common.md#proportionate-development #78feb28 현재 27파일·45 H2의 표 아홉 행은 전수 self-check 생산자로 다시 만든다. 본문은 v-077의 26파일·37 H2와 짧아진 지붕 둘, 늘어난 기존 열여덟 파일의 변경 이유, 그대로인 여섯 파일 및 새 site를 구별하되 변할 수 있는 현행 숫자는 표를 유일한 owner로 둔다.
-->
...
| openings·junctions·circulation | 3/8 | 6319·4705·1869 |
...
| ownership·observations | 2/4 | 3860·8118 |
| site | 1/6 | 5518 |
