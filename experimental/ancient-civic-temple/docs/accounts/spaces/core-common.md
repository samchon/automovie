...
<!--
@evidenceReview obligations/core/common.md#proportionate-development #78feb28 현재 27파일·45 H2의 생성 표 아홉 행에서 후퇴벽 주소와 보조 관찰을 더한 openings·observations의 분량까지 self-check 출력으로 다시 대조했다. v-077의 26파일·37 H2와 줄어든 두 지붕·불변 여섯 파일·새 site 비교는 본문에 남고 변하는 현행 분량은 표에서 읽는다.
-->
...
| openings·junctions·circulation | 3/8 | 6564·4705·1869 |
...
| ownership·observations | 2/4 | 3860·8378 |
| site | 1/6 | 5518 |
