...
<!--
@evidenceReview obligations/core/common.md#proportionate-development #78feb28 표의 27파일 값을 `npm run self-check`가 같은 방식으로 다시 출력해 일치하고(openings 5426, junctions 4705, observations 7863 포함), v-077 대비 늘어난 열여덟 파일 모두가 v-077→현재 값과 그 파일을 바꾼 변경을 가지며 짧아진 둘과 그대로인 여섯도 구별된다.
-->
...
| openings·junctions·circulation | 3/8 | 5426·4705·1869 |
...
| ownership·observations | 2/4 | 3860·7863 |
| site | 1/6 | 5518 |
