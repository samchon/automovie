...
<!--
@evidenceReview obligations/core/common.md#proportionate-development #78feb28 53 H2의 분포를 실제 일곱 파일과 비교했다. 외피·방 기능·독립 물체가 각각 8·8·9개로 분해되고 배경은 5개에 제한된다. 카메라 충돌처럼 결과가 큰 입력은 더 상세하며 범위가 같은 draft의 방과 관찰 약속이 줄지 않았다.
-->
