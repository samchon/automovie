...
<!--
@evidenceReview obligations/core/common.md#layer-boundary #5271f94 치수 허용값을 실제 벽 좌표와, 색 관계를 roughness 수치와, CJS 요구를 동작 로그와 대조했다. 어느 settings 파일도 실행 코드나 배치 수량을 소유하지 않으며 wiki 후보도 canon으로 편입하지 않았다.
-->
