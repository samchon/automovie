...
<!--
@evidenceReview obligations/core/common.md#proportionate-development 일곱 파일의 H2 분포 10·5·8·8·9·5·8과 실제 역할을 다시 대조했다. 설치 예외는 execution-authority, 같은 커밋 조건은 author-commits에 추가돼 기존 제작 조건 8개를 유지한다. 외피·방별 용도·물체의 세분화나 카메라 충돌 관찰 내용은 줄지 않았고 절차 변경을 별도 건물 주제로 늘리지 않았다.
-->
