...
<!--
@evidenceReview obligations/core/common.md#purpose-fit #7b32c66 일곱 파일을 실제로 대조했다. 실내 역할만 남기면 제단·용기 비례가 비고, 물체만 남기면 작성·열람의 배치가 비며, 제작 조건을 빼면 소프트웨어 프레임과 현재 source의 구별이 사라진다는 서로 다른 누락을 account가 설명한다.
-->
...
<!--
@evidenceReview obligations/core/common.md#layer-boundary #5271f94 settings 일곱 파일은 범위·정체성·권한을 소유하고 새 spaces의 좌표·지붕 단면은 이 account의 설정 비교 밖이다. 물체 이름과 치수 범위가 실제 prototype/placement를 대신하지 않으며 CJS 선택도 실행 성공으로 서술되지 않는다. 선행 wiki는 치수 canon의 소유가 아니다.
-->
...
<!--
@evidenceReview obligations/core/common.md#production-language #3ef4142 방의 용도는 관리실·기록실·보관실이라는 한국어로 읽히고 영어는 API·경로·고정 값에 남는다. m/rad/s와 이동 포락의 풀이도 확인했으며 미래 viewer의 한국어 약속을 현재 UI 제공으로 서술하지 않았다.
-->
...
<!--
@evidence obligations/core/common.md#proportionate-development 설정의 53 H2를 일곱 파일 전체에서 비교했다. 외피 8·실내 8·독립 물체 9개로 건물/실내를 분해하고 작은 배경은 5개로 제한했다. 설치와 lockfile 권한 정정은 기존 제작 조건의 두 H2에 남겨 건물 범위를 압축하거나 실행 절차를 새 시각 주제로 부풀리지 않았다.
-->

<!--
@evidenceReview obligations/core/common.md#proportionate-development #78feb28 일곱 파일의 H2 분포 10·5·8·8·9·5·8과 실제 역할을 다시 대조했다. 설치 예외는 execution-authority, 같은 커밋 조건은 author-commits에 추가돼 기존 제작 조건 8개를 유지한다. 외피·방별 용도·물체의 세분화나 카메라 충돌 관찰 내용은 줄지 않았고 절차 변경을 별도 건물 주제로 늘리지 않았다.
-->
