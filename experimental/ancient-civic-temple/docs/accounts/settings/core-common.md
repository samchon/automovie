...
<!--
@evidenceReview obligations/core/common.md#layer-boundary settings 일곱 파일은 범위·정체성·권한을 소유하고 새 spaces의 좌표·지붕 단면은 이 account의 설정 비교 밖이다. 물체 이름과 치수 범위가 실제 prototype/placement를 대신하지 않으며 CJS 선택도 실행 성공으로 서술되지 않는다. 선행 wiki는 치수 canon의 소유가 아니다.
-->
