...
@evidenceReview settings/20-envelope.md#entrance-porch #a164498 덮개가 현관 몸체를 넘지 않아 파라펫 사이 포치 박공이 정면에서 온전히 보인다.
@evidenceReview settings/20-envelope.md#colonnade #486e66f 남쪽 주랑과 두 꼬리가 같은 덮개 아래 있어 포치와 무관하게 한 고리의 지붕이 이어진다.
-->
