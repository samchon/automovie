...
@evidence settings/20-envelope.md#entrance-porch 두 원주 위 보가 실제 roof 하부에 닿는 작은 정면 박공을 넓은 회벽 파라펫 사이에 배정한다.
...
Z 범위는 entrance-back부터 south-outer에서 0.35m 앞으로 나간 처마선까지다. 뒤끝은 현관 후퇴벽의 북쪽 면이며 후퇴벽은 포치 하부까지 올라 이 지붕을 받친다. 앞끝만 외곽 밖으로 돌출하고 포치 바닥·기둥은 직사각 외곽 안에 있다. 기둥 위 보는 상면 수치가 아니라 실제 하부면에 접촉하며, 보 위와 포치 하부 사이의 삼각 막음은 남측 입면이 소유한다.
