...
@evidence principles/design/spaces.md#space-topology 기둥과 바닥은 직사각 외곽 안에 남고 처마만 돌출하며 뒤끝은 남쪽 canopy와 합성한다.
@evidence principles/design/spaces.md#space-boundary-authority 포치 상면·트림 결속면·외부 하부는 porch roof가 맡고 현관 바닥/기둥과 정면 벽을 복제하지 않는다.
@evidence principles/design/spaces.md#space-verification-address 정면·양 사선·문턱 올려다봄과 뒤끝 단면에서 받침 공백 및 돌출/끝 높이를 확인한다.
@evidence principles/core/inherited-units.md#derived-parent-differentiation 포치 정체성에 별도 지지 상면과 반환벽 바깥 기준의 처마 끝을 정해 낮은 지붕이 읽힐 단면을 제공한다.
