...
@evidenceReview principles/design/spaces.md#space-boundary-authority #d114e35 방 안쪽 표면은 각 room에 남기고 동측 입면은 외벽 실체와 바깥면·모서리 칸 코핑을 맡는다. 서비스 문턱의 Y=0 접점은 이 H2가 지면 표면 소유를 가져오지 않는다.
