...
@evidenceReview principles/core/common.md#declared-basis #7ccd1cb Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview principles/core/common.md#scope-preservation #24155e1 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview principles/core/common.md#substantive-completion #5b9d0e7 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview principles/core/inherited-units.md#derived-parent-differentiation #0632226 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview principles/design/spaces.md#space-boundary-authority #d114e35 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview principles/design/spaces.md#space-topology #3f8d925 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview principles/design/spaces.md#space-verification-address #a143ab1 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview upstream/design/spaces.md#settings-and-map-revision-from-space-work #46f1b62 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#delivery-scope #1b40e35 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#governing-aim #2aba9c6 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#subject-breakdown-production-scope #34ec6da Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#audience-operator-access #0e8cb17 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#accessibility-deliverable-states #2d42342 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#coordinate-unit-convention #01e5537 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#stage-policy #49599e9 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#delivery-review-condition #fb23db4 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#settings-coverage-map #68dee2e Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#design-dependent-subject-conditions #cfc9e04 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#subject-observable-identity-and-fit-out-limits #73d6425 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
...
@evidenceReview settings/temple.md#reference-interpretation-boundary #5814353 Read the cited target and this host's complete body; checked the host-specific spatial decision against the reviewed spaces graph and its stated scope.
-->
...
건물의 world와 site frame은 settings와 동일한 오른손 metre 좌표를 사용한다. X는 west에서 east, Y는 바닥에서 위, Z는 south에서 north로 증가한다. 남쪽 현관에서 북쪽을 보면 west가 왼쪽이고 east가 오른쪽이다. ground storey datum은 Y=0.00이며 clear ceiling datum은 Y=3.60이다. 건물의 semantic outer footprint는 `building` 하나로 X=-12.00..12.00, Z=-9.00..9.00을 갖고 gross area는 432.00㎡로 도출된다. 이 bounds는 외벽 바깥면이며, 외벽 두께·개구부 host 깊이·실 clear box의 안쪽 면은 envelope H2에서 함께 닫는다.
...
`colonnade-loop`는 outer rectangle와 inner courtyard rectangle 사이의 하나의 ring이다. 네 변의 clear circulation width는 spaces가 settings의 `1.50m 이상` 조건을 만족하도록 `author-adopted`한 local realization인 2.00m이며, 각 corner square를 포함하므로 south-west에서 north-west, north-east, south-east를 거쳐 다시 south-west로 끊김 없이 돌아온다. 이 ring 안에는 다른 corridor나 private shortcut이 없다. 방 문은 각각 0.40m 두께의 shared room-loop partition을 관통해 ring에 직접 열리며 한 방을 통과해 다른 방으로 가지 않는다.
...
| `door-records` | `colonnade-loop` | `records-room` | 1.10m | 0.40m room-loop partition | Y=0.00..2.10 | direct room door |
...
| --- | --- | --- |
| `elevation-south`, `elevation-north`, `elevation-west`, `elevation-east` | four exterior faces of the 0.60m exterior-wall envelope | materials; entrance/service/door models at named voids |
