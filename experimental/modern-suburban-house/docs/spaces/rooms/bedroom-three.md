...
@evidence settings/10-house.md#bedroom-three upper-hall에서 닿는 자기 문과 외벽 창을 갖고 수납실만 한 크기로 축소하지 않은 두 번째 자녀 침실로 만든다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation "침구색과 창 주변 가구 배치로 별도 방임이 읽혀야"를 왼쪽 잠자리·전면 중앙 책상·오른쪽 옷장의 bedroom-two와 다른 배치로 만든다.
