...
[욕조 겸 샤워·변기·세면장](../../settings/10-house.md#tub-bathroom)의 배치는 뒤쪽으로 긴 순내부 2.28 × 4.09 m를 소비한다. 오른쪽 외벽에 자기 채광/프라이버시 창을 배정하되 정확한 개구부와 기구 점유는 아직 미완료다. `src/spaces/rooms/tub-bath.ts`가 소유한다. 변기나 세면장을 넘지 않고 욕조에 닿는 경로, 문/창의 실제 방 binding, 모든 구석과 부재 읽힘은 unverified다.
