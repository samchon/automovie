...
@evidenceExclude upstream/design/spaces.md#settings-and-map-revision-from-space-work storage의 사람이 들어가는 수납실 조건과 primary-bedroom의 별도 옷 수납, upper-hall의 비통과 욕실을 대조했고 욕실 쪽 문 없이 성립해 부모 수정이 없었다.
-->
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation "문짝·문선·옷걸이/선반과 실제 내부 깊이"를 걸기/접기 구간 분할과 높이 반복 규칙으로 만든다.
...
@evidence settings/10-house.md#storage 옷걸이·선반과 실제 내부 깊이를 가진 옷 수납으로 만든다.
