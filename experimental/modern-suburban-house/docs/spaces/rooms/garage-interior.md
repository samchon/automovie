...
정면의 [garage-front-door와 상부 이동 예약](../envelope/front.md#garage-front-opening), 측면의 [garage-right-window](../envelope/right.md#garage-right-window)를 소비한다. 실제 문틀/레일·창호·수납 배치는 아직 미완료다. 문이 닫혀도 머드룸을 통해 내부 관찰에 도달한다. 초기 가구/차량 점유를 비우되, [설정이 요구하는 선반·공구와 차고 구조](../../settings/10-house.md#garage)를 면제하지 않는다. 자동차·주차용 가짜 실루엣·차량의 일부는 추가하지 않는다.
