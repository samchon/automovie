...
@evidence principles/core/common.md#declared-basis 박공 중심은 roof-mass-allocation, 높이 F는 roof-profile-datums, 뒤쪽 윤곽은 roof-shared-edges의 골짜기에서 받는다.
...
@evidenceExclude upstream/design/spaces.md#settings-and-map-revision-from-space-work main-mass의 "각 박공은 실제 삼각 벽과 양쪽 경사 지붕"을 -X 면에 대조했고 주 지붕 앞 면과의 골짜기에서 끝나 별도 동이나 층이 필요 없어 부모 수정이 없었다.
-->
