...
@evidenceReview principles/core/common.md#scope-preservation #24155e1 roof.garage.back이 차고 영역 뒤 절반의 Gback 날씨 면·아래면, 차고 후벽 자유 처마, 왼쪽 본채 벽 접합과 family/tub-right-window 겹침 관계를 garage-back.ts 범위에 담음을 확인했다.
...
@evidenceReview principles/design/spaces.md#space-boundary-authority #d114e35 공용부 창·상층 욕조 욕실 창 위치를 right.md 두 창 H2와 right-roof-closures 접촉선에서 읽고 '이 면은 창 좌표를 정하지 않는다'고 적은 본문을 대조해 차고 뒤 면이 창 좌표를 재저작하지 않음을 확인했다.
