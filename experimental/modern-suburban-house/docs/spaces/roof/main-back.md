...
@evidence principles/design/spaces.md#space-boundary-authority 높이는 00-junctions의 Mback과 주 지붕 영역에서만 받고 오른쪽 단차는 right 입면의 단차 벽이 닫으므로 이 면이 그 경계를 뚫거나 다시 만들지 않는다.
