...
@evidence principles/core/common.md#substantive-completion 전면 성목 H 8.00 m·수관 반지름 3.00 m, 뒤뜰 나무 H 6.00 m·반지름 2.00 m, 줄기·가지·수관의 결정적 생성식을 정한다 세 번째 줄기 링을 Y=0.76H로 정해 앞나무 6.08 m·뒤나무 4.56 m에서 수관과 만난다.
...
레퍼런스 01의 전면 큰 나무와 02의 뒤뜰 나무를 두 높이 변형으로 채택한다. 가지를 사진 윤곽대로 베끼지 않는다.
...
줄기의 세 번째 12각 링은 Y=0.76H에 놓아 중앙 수관 중심과 맞춘다. 기존 첫 가지 링 Y=0.32H와 바닥 링 Y=0 사이의 두 축 구간은 각각 선형 테이퍼하고, 위쪽 줄기는 중앙 군집 안에서 끝난다. 앞나무 링 높이는 0·2.56·6.08 m, 뒤나무는 0·1.92·4.56 m이며 나머지 꼭대기 수관은 가지와 잎 군집이 맡는다.
