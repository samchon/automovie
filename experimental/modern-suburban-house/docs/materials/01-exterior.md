...
@evidence principles/design/materials.md#material-construction-appearance 따뜻한 백색 lap siding은 구성을 '공장 도장한 섬유시멘트 판'로, 외관을 #EDE8DC·roughness 0.55·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 따뜻한 백색 lap siding은 #EDE8DC·roughness 0.55·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 흰 외부 trim은 구성을 '반광 도장한 PVC·목재 trim 판'로, 외관을 #F6F4EE·roughness 0.35·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 흰 외부 trim은 #F6F4EE·roughness 0.35·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 어두운 asphalt shingle은 구성을 '광물 입자를 입힌 asphalt shingle'로, 외관을 #3A3C3E·roughness 0.90·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 어두운 asphalt shingle은 #3A3C3E·roughness 0.90·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/common.md#scope-preservation 붉은갈색 벽돌은 네 입면 owner의 기단 노출 수직 면, `src/spaces/envelope/left.ts`의 굴뚝 몸체, `src/spaces/rooms/living.ts`의 벽난로 본체에 마감만 결합하고 그 면의 geometry·경계와 개수는 host owner에 남긴다.
...
@evidence principles/design/materials.md#material-construction-appearance 붉은갈색 벽돌은 구성을 '소성 점토 벽돌과 시멘트 모르타르 줄눈'로, 외관을 #8A4A3A·roughness 0.85·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 붉은갈색 벽돌은 #8A4A3A·roughness 0.85·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
<!--
@evidence principles/core/common.md#declared-basis charcoal 창틀과 굴뚝 cap의 #2E3033·roughness 0.40은 settings/20-verification.md#visual-grammar의 조건을 근거로 한 이 branch의 선택이며 사진 픽셀 값이 아니라고 00 색 공간 규칙과 함께 밝힌다.
@evidence principles/core/common.md#scope-preservation charcoal 창틀과 굴뚝 cap은 models/01-windows.md#window-surface-partitions, models/02-exterior-doors.md#front-entry-door, models/02-exterior-doors.md#garden-door-pair의 면에 마감만 결합하고 그 면의 geometry·경계는 host owner에 남긴다.
@evidence principles/core/common.md#substantive-completion charcoal 창틀과 굴뚝 cap은 #2E3033(선형 0.027, 0.030, 0.033), roughness 0.40, metallic 0.0, transmission 0.0, 결합 면, source owner `src/materials/exterior/frames.ts`, 리뷰 관찰을 모두 적었다.
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/20-verification.md#visual-grammar는 색·재료를 말로만 정했고 charcoal 창틀과 굴뚝 cap은 #2E3033 값과 roughness 0.40, `frame`·`sash`·`mullion`·`muntin` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance charcoal 창틀과 굴뚝 cap은 구성을 '분체 도장 알루미늄'로, 외관을 #2E3033·roughness 0.40·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface charcoal 창틀과 굴뚝 cap의 결합 vocabulary는 `frame`·`sash`·`mullion`·`muntin`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
@evidence principles/design/materials.md#material-verification-address charcoal 창틀과 굴뚝 cap의 반증 견본은 '흰 trim 안에서 창틀이 검은 구멍이 아니라 두께 있는 틀로 읽히는지'이고 00 재료 리뷰 견본의 중성 조명 판이 #2E3033 값을 대조한다.
@evidenceExclude upstream/design/materials.md#parent-revision-from-material-work charcoal 창틀과 굴뚝 cap은 settings/20-verification.md#visual-grammar, models/01-windows.md#window-surface-partitions를 적힌 그대로 소비했고 수정할 부모 결함을 찾지 않았다.
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap charcoal 창틀과 굴뚝 cap은 #2E3033·roughness 0.40·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 투명 창유리는 구성을 '두께 0.006 m 판유리 한 장으로 근사하며 복층 공기층은 표현하지 않는'로, 외관을 #E8EEF0·roughness 0.03·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 투명 창유리는 #E8EEF0·roughness 0.03·metallic 0.0·transmission 0.92 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 불투명 욕실 유리는 구성을 '한 면을 산성 부식한 판유리'로, 외관을 #E8EEF0·roughness 0.55·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 불투명 욕실 유리는 #E8EEF0·roughness 0.55·metallic 0.0·transmission 0.80 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 꿀빛 목재 현관문은 구성을 '오일 마감 참나무 판 문짝'로, 외관을 #9A6A3E·roughness 0.50·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 꿀빛 목재 현관문은 #9A6A3E·roughness 0.50·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance charcoal 차고문 패널은 구성을 '도장 강판 분절 패널'로, 외관을 #34373A·roughness 0.45·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap charcoal 차고문 패널은 #34373A·roughness 0.45·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 포치 바닥은 구성을 '도장 콘크리트 상부판'로, 외관을 #A8A49C·roughness 0.80·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 포치 바닥은 #A8A49C·roughness 0.80·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 포장 콘크리트는 구성을 '빗자루 마감 현장 타설 콘크리트'로, 외관을 #B4B0A8·roughness 0.88·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 포장 콘크리트는 #B4B0A8·roughness 0.88·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#site-identity는 색·재료를 말로만 정했고 중간갈색 울타리 목재는 #8C6A48 값과 roughness 0.75, `leaf-panel` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 중간갈색 울타리 목재는 구성을 '착색한 방부 목재 판'로, 외관을 #8C6A48·roughness 0.75·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 중간갈색 울타리 목재의 결합 vocabulary는 `leaf-panel`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 중간갈색 울타리 목재는 #8C6A48·roughness 0.75·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
