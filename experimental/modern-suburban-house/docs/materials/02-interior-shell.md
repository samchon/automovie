...
@evidence principles/design/materials.md#material-construction-appearance 따뜻한 밝은 벽 도장은 구성을 '석고보드 위 무광 수성 도장'로, 외관을 #F1EEE6·roughness 0.60·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 따뜻한 밝은 벽 도장은 #F1EEE6·roughness 0.60·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 평평한 흰 천장은 구성을 '석고보드 위 무광 흰 도장'로, 외관을 #FAF9F6·roughness 0.65·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 평평한 흰 천장은 #FAF9F6·roughness 0.65·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#openings는 색·재료를 말로만 정했고 흰 실내 trim과 패널 문짝은 #F4F2EC 값과 roughness 0.35, `leaf`·`leaf-panel`·`jamb`·`casing` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 흰 실내 trim과 패널 문짝은 구성을 '반광 도장한 목재·MDF 부재'로, 외관을 #F4F2EC·roughness 0.35·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 흰 실내 trim과 패널 문짝의 결합 vocabulary는 `leaf`·`leaf-panel`·`jamb`·`casing`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 흰 실내 trim과 패널 문짝은 #F4F2EC·roughness 0.35·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 참나무색 마루는 구성을 '폭 0.13 m 판의 오일 마감 원목 마루'로, 외관을 #B08050·roughness 0.50·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 참나무색 마루는 #B08050·roughness 0.50·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence spaces/10-ground-floor.md#main-ground-floor-base 1층 바탕이 마루·타일 차이에도 높이를 맞추므로 참나무색 마루는 그 완성 면에 #B08050 상수 마감으로만 결합하고 바탕 높이를 바꾸지 않는다.
-->

[실내 현관의 참나무색 마루](../settings/10-house.md#entry)이고 1층 거실·공용부·서비스 통로·팬트리에 이어진다. 구성은 폭 0.13 m 판의 오일 마감 원목 마루이며 판 이음 선은 비트맵이 아니라 방 owner의 바닥 geometry 분할로만 표현한다. 외관은 결 없이 오일 마감 표면의 색과 광택만 근사하는 `#B08050`(선형 0.434, 0.216, 0.080), roughness 0.50, metallic 0.0, transmission 0.0이다. 결합 면은 entry·living·common·service·pantry owner의 보이는 바닥 마감이다. 문턱에서 다른 재료로 바뀌는 선은 [실내 경계의 문턱](../spaces/07-boundary-assembly.md#interior-boundary-junctions)을 따른다. source owner는 `src/materials/interior/floors.ts`이고, 리뷰는 04와 03의 비교 view에서 마루가 꿀빛으로 읽히고 파우더룸·세탁실 문턱에서 끊기는지를 관찰한다.
...
@evidence principles/design/materials.md#material-construction-appearance 밝은 목재 계단 디딤판은 구성을 '마루와 같은 수종의 두께 있는 참나무 디딤판'로, 외관을 #B08050·roughness 0.50·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 밝은 목재 계단 디딤판은 #B08050·roughness 0.50·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 목재 난간 손잡이는 구성을 '오일 마감 경목 원형 단면 부재'로, 외관을 #8A5A34·roughness 0.45·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 목재 난간 손잡이는 #8A5A34·roughness 0.45·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 검은 도장 금속은 구성을 '분체 도장 강재'로, 외관을 #1F1F20·roughness 0.40·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 검은 도장 금속은 #1F1F20·roughness 0.40·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 베이지 카펫은 구성을 '짧은 루프 파일 카펫과 하부 패드'로, 외관을 #CDBFA6·roughness 0.95·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 베이지 카펫은 #CDBFA6·roughness 0.95·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence spaces/08-floor-assembly.md#interstorey-floor-boundary 층간 바닥이 타일과 카펫의 두께 차로 새 단을 만들지 않게 했으므로 베이지 카펫은 방 owner의 완성 바닥 면에 상수 마감으로만 결합하고 datum을 바꾸지 않는다.
...
[상층 복도의 베이지 카펫](../settings/10-house.md#upper-hall)과 [주침실](../settings/10-house.md#primary-bedroom)·[두 작은 침실](../settings/10-house.md#bedroom-two)의 중성 카펫을 한 재료로 정한다. 한 재료로 두는 이유는 두 작은 침실이 주침실의 재료 체계를 잇는다는 settings 조건이다. 구성은 짧은 루프 파일 카펫과 하부 패드이며 파일 결은 표현하지 않는다. 외관은 `#CDBFA6`(선형 0.610, 0.521, 0.381), roughness 0.95, metallic 0.0, transmission 0.0이다. 결합 면은 upper-hall·primary·wardrobe·bedroom-two·bedroom-three owner의 보이는 바닥 마감이며 [욕실 문턱에서 끝난다](../settings/10-house.md#shower-bathroom). source owner는 `src/materials/interior/floors.ts`이고, 리뷰는 05 view에서 카펫이 마루보다 밝고 하이라이트 없이 읽히며 욕실 문턱에서 타일과 경계가 맞는지를 관찰한다.
...
@evidence principles/design/materials.md#material-construction-appearance 욕실 바닥 타일은 구성을 '유약 자기질 타일 0.30 m 모듈'로, 외관을 #D8D4CC·roughness 0.40·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 욕실 바닥 타일은 #D8D4CC·roughness 0.40·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 욕실 벽 타일은 구성을 '유약 도기 벽 타일'로, 외관을 #EEEDEA·roughness 0.30·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 욕실 벽 타일은 #EEEDEA·roughness 0.30·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 타일 줄눈은 구성을 '시멘트 줄눈'로, 외관을 #A9A39A·roughness 0.90·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 타일 줄눈은 #A9A39A·roughness 0.90·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
-->
...
@evidence principles/design/materials.md#material-construction-appearance 세탁실 밝은 회색 바닥은 구성을 '비닐 판 바닥'로, 외관을 #C9C4BA·roughness 0.50·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 세탁실 밝은 회색 바닥은 #C9C4BA·roughness 0.50·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 차고 콘크리트는 구성을 '흙손 마감 콘크리트 슬래브'로, 외관을 #9C9890·roughness 0.85·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 차고 콘크리트는 #9C9890·roughness 0.85·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
