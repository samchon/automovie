...
@evidence principles/design/materials.md#material-binding-interface 흰 실내 trim과 패널 문짝의 결합 vocabulary에는 문짝·문설주·문선의 `leaf`·`leaf-panel`·`jamb-a`·`jamb-b`·`jamb-core`·`casing-a`·`casing-b`, 창대 `interior-sill`, 독립 걸레받이 `wall-baseboard`가 있고 계단 챌판·기둥은 spaces 계단 owner의 면을 쓴다.
