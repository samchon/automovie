...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#kitchen-equipment는 색·재료를 말로만 정했고 회갈색 패널 수납장은 #8A7F72 값과 roughness 0.50, `plinth`·`carcass`·`front`·`carcass` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 회갈색 패널 수납장은 구성을 '두께 0.018 m MDF 패널 위 반무광 도장'로, 외관을 #8A7F72·roughness 0.50·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 회갈색 패널 수납장의 결합 vocabulary는 `plinth`·`carcass`·`front`·`carcass`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 회갈색 패널 수납장은 #8A7F72·roughness 0.50·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 밝은 석재 상판은 구성을 '두께 0.03 m 엔지니어드 석재 판'로, 외관을 #E4E0D8·roughness 0.30·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 밝은 석재 상판은 #E4E0D8·roughness 0.30·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#kitchen-equipment는 색·재료를 말로만 정했고 스테인리스 가전과 수전은 #C0C2C4 값과 roughness 0.30, `door-left`·`door-right`·`drawer`·`body` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 스테인리스 가전과 수전은 구성을 '도장하지 않은 헤어라인 스테인리스 강판과 주물 수전'로, 외관을 #C0C2C4·roughness 0.30·metallic 1.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 스테인리스 가전과 수전의 결합 vocabulary는 `door-left`·`door-right`·`drawer`·`body`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 스테인리스 가전과 수전은 #C0C2C4·roughness 0.30·metallic 1.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/20-verification.md#visual-grammar는 색·재료를 말로만 정했고 검은 유리 조작부는 #1F1F20 값과 roughness 0.08, `cooktop`·`burner`·`control-band`·`door-window` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 검은 유리 조작부는 구성을 '검은 유리 세라믹 판'로, 외관을 #1F1F20·roughness 0.08·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 검은 유리 조작부의 결합 vocabulary는 `cooktop`·`burner`·`control-band`·`door-window`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 검은 유리 조작부는 #1F1F20·roughness 0.08·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
-->
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#laundry-mudroom는 색·재료를 말로만 정했고 흰 에나멜과 도기는 #F5F5F2 값과 roughness 0.25, `ceramic`·`seat`·`lid`·`seat-lid` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 흰 에나멜과 도기는 구성을 '유약 도기와 법랑 강판'로, 외관을 #F5F5F2·roughness 0.25·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 흰 에나멜과 도기의 결합 vocabulary는 `ceramic`·`seat`·`lid`·`seat-lid`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 흰 에나멜과 도기는 #F5F5F2·roughness 0.25·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 꿀빛 가구 목재는 구성을 '오일 마감 참나무 집성재'로, 외관을 #A87A4E·roughness 0.50·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 꿀빛 가구 목재는 #A87A4E·roughness 0.50·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#living는 색·재료를 말로만 정했고 짙은 책장 목재는 #4A3A2E 값과 roughness 0.55, `case`·`shelf`·`back-panel`·`book` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 짙은 책장 목재는 구성을 '어두운 착색 호두나무 판재'로, 외관을 #4A3A2E·roughness 0.55·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 짙은 책장 목재의 결합 vocabulary는 `case`·`shelf`·`back-panel`·`book`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 짙은 책장 목재는 #4A3A2E·roughness 0.55·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 회베이지 천갈이는 구성을 '폼 위 직조 폴리 직물'로, 외관을 #B7AFA3·roughness 0.92·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 회베이지 천갈이는 #B7AFA3·roughness 0.92·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 회베이지 주침실 침구는 구성을 '면 직물 이불·베개'로, 외관을 #CFC8BC·roughness 0.93·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 회베이지 주침실 침구는 #CFC8BC·roughness 0.93·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 올리브 침구는 구성을 '면 직물 이불'로, 외관을 #6B7040·roughness 0.92·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 올리브 침구는 #6B7040·roughness 0.92·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 청회색 침구는 구성을 '면 직물 이불'로, 외관을 #6E7F8C·roughness 0.92·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 청회색 침구는 #6E7F8C·roughness 0.92·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/design/materials.md#material-construction-appearance 절제된 러그는 구성을 '얇은 양모 직물'로, 외관을 #8E8579·roughness 0.95·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 절제된 러그는 #8E8579·roughness 0.95·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence principles/core/common.md#scope-preservation 흰 수건과 얇은 커튼은 models/14-bathrooms.md#towel-bar, models/14-bathrooms.md#tub-curtain-rail, models/13-bedrooms.md#wardrobe-shelves의 면에 마감만 결합하고 그 면의 geometry·경계는 host owner에 남긴다.
@evidence principles/core/common.md#substantive-completion 흰 수건과 얇은 커튼은 수건 #EAE6DC(roughness 0.95)와 커튼 #EDE9E0(roughness 0.90, transmission 0.30, 양면) 값, 수건·욕조 커튼·접힌 린넨의 models 14·13 파티션 결합, source owner `src/materials/furnishings/textiles.ts`를 적었지만 주침실 창 커튼은 models에 원형이 없어 결합 면이 비어 있다고 본문이 밝히며 이 미결은 models 층의 누락으로 남는다.
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#shower-bathroom는 색·재료를 말로만 정했고 흰 수건과 얇은 커튼은 #EAE6DC 값과 roughness 0.95, `towel`·`curtain`·`curtain-open`·`folded` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 흰 수건과 얇은 커튼은 구성을 '파일 면 직물(수건)과 얇은 폴리 직물(커튼)'로, 외관을 #EAE6DC·roughness 0.95·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 흰 수건과 얇은 커튼의 결합 vocabulary는 `towel`·`curtain`·`curtain-open`·`folded`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 흰 수건과 얇은 커튼은 #EAE6DC·roughness 0.95·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
@evidence settings/10-house.md#primary-bedroom 흰 수건과 얇은 커튼이 '주침실'(settings/10-house.md#primary-bedroom)를 링크로 소비해 #EAE6DC 값과 결합 면의 근거로 삼았다.
...
@evidence principles/core/inherited-units.md#derived-parent-differentiation 부모 settings/10-house.md#powder는 색·재료를 말로만 정했고 거울은 #EDEDED 값과 roughness 0.02, `mirror-glass`·`frame` 결합을 더한다.
@evidence principles/design/materials.md#material-construction-appearance 거울은 구성을 '뒷면 은막을 입힌 유리 판'로, 외관을 #EDEDED·roughness 0.02·metallic 1.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
@evidence principles/design/materials.md#material-binding-interface 거울의 결합 vocabulary는 `mirror-glass`·`frame`이며 방향과 단면/양면은 00 면 결합 규칙을 따른다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 거울은 #EDEDED·roughness 0.02·metallic 1.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
@evidence settings/10-house.md#powder 거울이 '파우더룸'(settings/10-house.md#powder)를 링크로 소비해 #EDEDED 값과 결합 면의 근거로 삼았다.
@evidence spaces/rooms/powder.md#powder-fixture-use powder-fixture-use가 materials에 넘긴 거울 재료를 `mirror-glass`의 #EDEDED, roughness 0.02, metallic 1.0으로 받는다.
-->
...
@evidence principles/design/materials.md#material-construction-appearance 벽난로 화구는 구성을 '그을린 내화 벽돌'로, 외관을 #1F1F20·roughness 0.90·metallic 0.0 상수로 나누고 외관이 구성의 최상층 마감만 근사한다고 적는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 벽난로 화구는 #1F1F20·roughness 0.90·metallic 0.0·transmission 0.0 상수만 두고 비트맵이나 절차적 결을 쓰지 않는다.
...
@evidence contracts/no-texture-bitmap.md#constant-response-no-bitmap 소품은 기존 상수 재료만 재사용하고 새 비트맵이나 결을 만들지 않는다.
