...
@evidence principles/design/materials.md#material-binding-interface 수건과 린넨의 `towel`·`folded`, 욕조와 주침실 창의 `curtain`·`curtain-open`을 분리 결속하며 얇은 커튼은 양면이다.
