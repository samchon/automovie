...
export const outdoorFurnitureSpecs: readonly PrototypeSpec[] = [
  ...group("15-outdoor.md", "src/models/furnishings/outdoor.ts", [
    ["terrace-table","table",[1.40,0.74,0.80],"top leg",{tableProfile:"terrace"}],
    ["terrace-chair","chair",[0.50,0.85,0.55],"seat leg back",{finishes:woodenChairFinishes,chairProfile:"terrace"}],
  ]),
];
