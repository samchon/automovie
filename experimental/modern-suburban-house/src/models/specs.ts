...
export type PrototypeRow = readonly [string, PrototypeKind, Size, string, Partial<Pick<PrototypeSpec,"bodyTop"|"mattressTop"|"rimHeight"|"wallBar"|"pendant"|"curtain"|"laundry"|"chairProfile"|"lShelf"|"finishes"|"finishAll">>?];
