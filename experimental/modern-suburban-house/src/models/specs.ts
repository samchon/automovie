...
export type PrototypeRow = readonly [string, PrototypeKind, Size, string, Partial<Pick<PrototypeSpec,"bodyTop"|"mattressTop"|"rimHeight"|"wallBar"|"pendant"|"curtain"|"lShelf"|"finishes"|"finishAll">>?];
