...
export type PrototypeRow = readonly [string, PrototypeKind, Size, string, Partial<Pick<PrototypeSpec,"bodyTop"|"mattressTop"|"rimHeight"|"wallBar"|"pendant"|"ceiling"|"curtain"|"laundry"|"chairProfile"|"tableProfile"|"borderWidth"|"tubCurtainLength"|"lShelf"|"finishes"|"finishAll">>?];
