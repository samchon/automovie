 ...
 * @evidenceReview {@link Human.IAutoMovieHumanFaceIris} #2a6bdfc Read left and right as the subject's own eyes mapped to the leftEye and rightEye owners; both pigments are refused on load and save by createPortraitIrisMaterials. No image or per-texel value is stored.
 * @evidence {@link Human.IAutoMovieHumanFaceIris.left} Read the subject's left-eye pigment, painted on the leftEye globe only.
 * @evidenceReview {@link Human.IAutoMovieHumanFaceIris.left} #fb71eab Read the subject's left-eye pigment, painted on the leftEye globe only.
 ...
 * @evidenceReview {@link Human.IAutoMovieHumanFaceIris.right} #dbd6375 Read the subject's right-eye pigment, painted on the rightEye globe only.
 ...
 * @evidenceReview {@link Human.createHumanFaceIrisPigment} #603b4e6 Read the globe as the textured, UV-bearing region triangles fully bound to one eye owner, texture references skipped, omission and null returning before any work, pigment validation before the eye checks, and the cache keyed by both pigments. The analytic scenario pins pupil, stroma, sclera and between-eye texels, the band endpoints, the cache identity and three refusals. Reread the globe search lifted into one helper, a partially bound lid and an untextured region skipped, and an articulated eye other than leftEye and rightEye refused by name.
 ...
 * @evidenceReview {@link Human.locateHumanFaceIrisDisc} #12233a6 Read the normal-equation sphere fit with pivot refusal, the posterior refit beyond 45 degrees, the refusal of a globe without protrusion or sclera, the vertical-axis reference fallback and the asin ratios of 11.71 and 3.5 to 24.2 mm with their cited sources.
 ...
 * @evidenceReview {@link Human.IHumanFaceIrisDisc} #80fdbfc Read the disc record the locator returns and the rasterizer and colour rule consume.
