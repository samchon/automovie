 ...
 * @evidenceReview {@link IAutoMovieHumanFaceHair} #804008a Read the complete numerical document after adding a six-coefficient root envelope. The same canonical layers still contain no generated coordinates, photographs or private resource keys; current population migration remains unfinished.
 ...
 * @evidenceReview {@link IAutoMovieHumanFaceHair.Layer} #81666af Read rootRegion beside area sampling, independent part.region, per-layer fields and editor transactions. Local root preference preserves the requested count and is explicitly not biological density.
 ...
 * @evidenceReview {@link assertHumanFaceHair} #b08ddd8 Read structural admission and both optional envelope paths. Finite centres and strictly positive finite spreads are required even at zero count; source-domain lookup and feasibility remain builder obligations.
 ...
 * @evidenceReview {@link createHumanFaceHairBuilder} #d36b594 Read shared domain/closure admission, neutral/current correspondence, owned construction and procedural finishes. The actual connected builder now calls this function; personal documents and population acceptance remain unfinished.
