 ...
 * @evidenceReview {@link Human.createHumanBodyBasisBuilder} #93e1e4e Read schema/revision admission, named shape and corrective evaluation, the coupled pose judged together with its pelvic-relative rhythm reading, shoulder goals refused outside the joint-sinus reach and resolved after girdle motion, the pelvis turned about the hip centres, rigid skinning and final model validation.
