 ...
 * @evidenceReview {@link Human.IAutoMovieHumanBodyBasis} #3efb638 Read the full schema and admission against the shipped connected asset: collar correspondence, endpoints, material partition, landmarks, skin, the shoulder contract with its joint-sinus envelope and the declared pelvifemoral rhythm.
 ...
 * @evidenceReview {@link Human.IAutoMovieHumanBodyBasis.joints} #b071d71 Read the rooted tree, landmark pivots, held generic upper-arm axes, measured bilateral thorax-TT rest, elevation and axial ranges, the periodic plane envelope, and four-influence skin binding.
 ...
 * @evidenceReview {@link Human.skinHumanBodySurface} #159043a Read the per-bone unit dual quaternion of `posed ∘ rest⁻¹`, its sign aligned parent to child once for the skin, the blend without per-vertex flipping, the normalization by the real part's norm and both refusals, and ran the skinning and hemisphere scenarios: a half-weighted vertex on the half-angle arc, a blend invariant to influence order at a 182 degree turn, and exact rigidity of unit-weight vertices.
