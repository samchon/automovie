 ...
 * @evidenceReview {@link Human.humanBodyBasisWeights} #8785a34 Read channel envelopes, coupled generic pose, total TT elevation ramp, the SO(3) geodesic shoulder kernel that agrees for equivalent 0/180 pole triples, and the division of one family's kernels by their sum where it exceeds one.
