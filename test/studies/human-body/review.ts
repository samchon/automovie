 ...
 * @evidenceReview {@link Human.IAutoMovieHumanBodyBasis} #34d6d11 Read the full schema and admission against the shipped connected asset: collar correspondence, endpoints, material partition, landmarks, skin and the shoulder contract with its joint-sinus envelope. The published r4 lacks that shoulder metadata and is explicitly refused until a new basis is issued.
 ...
 * @evidenceReview {@link Human.assertHumanBodyRig} #b31a52a Read tree, measured bilateral thorax-TT rest, envelope knot order, canonical planes, positive in-range maxima and a rest inside the region, held old upper-arm axes, source-relative corrective ramps and orientation kernels whose centres lie in the reach, coupling limits, and unit-sum skin.
 ...
 * @evidenceReview {@link Human.createHumanBodyBasisBuilder} #090b632 Read schema/revision admission, named shape and corrective evaluation, coupled generic pose, shoulder goals refused outside the joint-sinus reach and resolved after girdle motion, rigid skinning and final model validation.
