 ...
 * @evidenceReview {@link Human.humanBodySimpleShapeMath} #e3b0230 Read the flat-ended curve and inverse, the distinct Deurenberg child/adult fits and fractional-age bridge, the visible fat the definition gates read (the regression's excess less 100 · Δ · muscle / BMI, adults only with a 15–18 ramp, floored at one point), Jensen's 1989 polynomial child head share and adult bridge, term product, and Siri density.
 ...
 * @evidenceReview {@link Human.HUMAN_BODY_SIMPLE_SHAPE} #ef26d48 Read the pinned table including separate Deurenberg child/adult regressions, the authored 15–16 continuity bridge, Jensen's 1989 boy-child polynomial head and neck share, adult share, the fat-free mass per unit of muscle by sex (Schutz 2002 medians, Kouri 1995 athletes), the muscle envelope to 2, and the soft-tissue rows (gluteal mass and tone, breast descent, fill, projection and volume, adipose male chest, abdominal tone and navel, submental, arm and thigh fat, the trained V, musculature and chest definition, skeletal prominence under muscle) with the recalibrated definition bands.
 ...
 * @evidenceReview {@link Human.IAutoMovieHumanBodySimpleShapeTable} #9ea9666 Read the age-specific fat coefficients, the muscle's fat-free mass index by sex, and quadratic child head and neck mass-share form, both transition ages, the envelope, head allowance and product-of-curves rows.
