 ...
 * @evidenceReview {@link Human.solveHumanBodyArmsDown} #6a1a290 Read the chain walk, the rest baseline, the bottom check and the one-degree bisection, and ran the arms-down scenario against an independently walked first-contact elevation.
