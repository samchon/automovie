 ...
 * @evidenceReview {@link Human.solveHumanBodyArmsDown} #c7d0447 Read the chain walk, the rest baseline, the bottom check and the one-degree bisection, and ran the arms-down scenario against an independently walked first-contact elevation.
