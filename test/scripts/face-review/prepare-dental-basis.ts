 ...
 *
 * The one input is the resting incisal display, the maxillary central
 * incisor's edge below the upper lip with the lips at rest: 1.91 mm in men
 * and 3.40 mm in women (Vig & Brundo 1978), 2.5 and 3.8 mm in a later sample
 * (Misch 2011). The basis neutral carries no sex, so it takes the midpoint of
 * the first, more conservative study, 2.655 mm; a sex, age or lip-length
 * difference is then carried by the lip's own shape channels, which move the
 * lip over a fixed dentition as tissue does over bone.
 */
import type {
...
const receipt = {
  ...
  citations: {
    ...
    occlusion:
      "Ricketts RM, A foundation for cephalometric communication, Am J Orthod 1960;46:330-57, as tabulated by PMC10198690 (J Clin Exp Dent 2023) Table 1: normal overbite 2.5 +- 2 mm, normal overjet 2.5 +- 2.5 mm. A rigid translation of both arches together leaves both unchanged.",
  },
  inputs: {
